...
rabbit.util={isLocalStorageSupported:function(){
var _1c4="test";
try{
localStorage.setItem(_1c4,"1");
localStorage.removeItem(_1c4);
return true;
}
catch(error){
return false;
...
var _1c5=e.stack.replace(/^[^\(]+?[\n$]/gm,"").replace(/^\s+at\s+/gm,"").replace(/^Object.<anonymous>\s*\(/gm,"{anonymous}()@").split("\n");
console.log(_1c5);
}
},parseBoolean:function(_1c6){
return _1c6===true||(_.isString(_1c6)&&_1c6.toLowerCase()==="true");
},bind:function(_1c7,_1c8){
return function(){
try{
return _1c7.apply(_1c8,arguments);
}
catch(e){
console.error(e);
}
...
name=name.replace(/[\[\]]/g,"\\$&");
var _1c9=new RegExp("[?&]"+name+"(=([^&#]*)|&|#|$)"),_1ca=_1c9.exec(url);
if(!_1ca){
return null;
}
if(!_1ca[2]){
...
return decodeURIComponent(_1ca[2].replace(/\+/g," "));
},bindSingleAndDoubleClick:function(_1cb,_1cc,_1cd,_1ce,_1cf){
_1cf=_1cf||500;
$(_1cb).click(function(_1d0){
...
}).dblclick(function(_1d1){
clearTimeout($(this).data("timer"));
$(this).data("timer",null);
return _1cd(_1d1);
});
},bindInput:function(_1d2,_1d3,_1d4,_1d5){
if(_1d5===undefined){
_1d5=_1d3;
}
Mousetrap(_1d2).bind("enter",_1d3);
Mousetrap(_1d2).bind(["escape","esc"],_1d4,"keyup");
if(_1d5){
$(_1d2).blur(function(_1d6){
_1d5(_1d6);
});
}
},emptyNode:function(node){
var _1d7=this.getChildren(node);
for(var i=_1d7.length-1;i>=0;i--){
node.removeChild(_1d7[i]);
}
...
var _1d8=node.childNodes;
var _1d9=[];
for(var i=0;i<_1d8.length;i++){
if(_1d8[i].nodeType===Node.ELEMENT_NODE){
_1d9.push(_1d8[i]);
}
}
return _1d9;
}
},scrollToRelative:function(_1da,_1db,_1dc){
var to=_1da.scrollTop+_1db;
this.scrollTo(_1da,to,_1dc);
},scrollTo:function(_1dd,to,_1de){
$(_1dd).animate({scrollTop:to},_1de);
},xmlEncode:function(_1df){
return _1df.toString().replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/"/g,"&quot;");
},xmlDecode:function(_1e0){
return _1e0.toString().replace(/&quot;/g,"\"").replace(/&lt;/g,"<").replace(/&amp;/g,"&");
},convertDate:function(_1e1){
if(_1e1=="7000000000000"){
return "not yet saved";
}
return Ext.util.Format.date(new Date(parseInt(_1e1)),"Y-m-d G:i");
},appendVersionQuery:function(_1e2){
return _1e2+"?v="+rabbit.parameters.codeVersion;
},cloneObject:function(_1e3){
return JSON.parse(JSON.stringify(_1e3));
},Class:function(_1e4,_1e5){
if(!_1e5){
_1e5=_1e4;
_1e4=function(){
};
...
this.parent=_1e4.prototype;
this.init.apply(this,arguments);
}
};
_1e5.call(F.prototype=new _1e4(rabbit.util.Class),_1e4.prototype);
return F;
},absoluteCenter:function(_1e6){
var left=$(_1e6).parent().width()/2-$(_1e6).width()/2;
var top=$(_1e6).parent().height()/2-$(_1e6).height()/2;
$(_1e6).css({left:left,top:top,position:"absolute"});
},getResolvedPromise:function(){
var _1e7=new jQuery.Deferred();
_1e7.resolve();
return _1e7.promise();
},addClass:function(_1e8,_1e9){
if(typeof _1e8==="string"){
_1e8=document.getElementById(_1e8);
}
_1e8.setAttribute("class",_1e8.getAttribute("class")+" "+_1e9);
},removeClass:function(_1ea,_1eb){
if(typeof _1ea==="string"){
_1ea=document.getElementById(_1ea);
}
_1ea.setAttribute("class",_1ea.getAttribute("class").replace(_1eb,""));
...
return 1;
},insertAtIndex:function(_1ec,key,_1ed,_1ee){
var tmp={};
var keys=_.keys(_1ec);
for(var i=0;i<keys.length;i++){
if(i>=_1ee){
tmp[keys[i]]=_1ec[keys[i]];
delete _1ec[keys[i]];
}
}
_1ec[key]=_1ed;
...
var _1ef=this.getChildren(node);
for(var i=0;i<_1ef.length;i++){
this.recursivelyRemoveId(_1ef[i]);
}
...
_1f0.style.visibility="hidden";
_1f0.style.width="100px";
_1f0.style.msOverflowStyle="scrollbar";
document.body.appendChild(_1f0);
var _1f1=_1f0.offsetWidth;
_1f0.style.overflow="scroll";
var _1f2=document.createElement("div");
_1f2.style.width="100%";
_1f0.appendChild(_1f2);
var _1f3=_1f2.offsetWidth;
_1f0.parentNode.removeChild(_1f0);
this.scrollbarWidth=_1f1-_1f3;
return this.scrollbarWidth;
}};
...
console.error=function(e,_1f4){
var line=(e.lineNumber!=null)?e.lineNumber:e.line;
var file=(e.fileName!=null)?e.fileName:e.sourceURL;
var data={"errorJSON":JSON.stringify(e),"message":((_1f4)?"From window.onerror ":"")+e.name+": "+e.message,"url":file,"line":line,"stack":e.stack};
...
window.onerror=function(_1f5,url,_1f6,_1f7,_1f8){
if(_1f8){
console.error(_1f8,true);
}else{
var data={"errorJSON":{},"message":"From window.onerror "+_1f5,"url":url,"line":_1f6,"stack":""};
rabbit.communication.manager.submitError(data);
if(document.URL.match(/http:\/\/localhost:.*/)||document.URL.match(/http(s)?:\/\/[^\/]*stage\.pidoco\.com.*/)){
console.oldError(null,arguments);
}
...
rabbit.facade={registerUserPref:function(key,_1f9){
rabbit.common.prefsManager.registerUserPref(key,_1f9);
},setUserPref:function(key,_1fa){
rabbit.common.prefsManager.setUserPref(key,_1fa);
},getUserPref:function(key){
return rabbit.common.prefsManager.getUserPref(key);
},setFrameSpecificUserPref:function(_1fb,_1fc,key,_1fd){
var _1fe=rabbit.util.cloneObject(rabbit.facade.getUserPref(key));
_1fe[_1fb]=_1fe[_1fb]||{};
_1fe[_1fb][_1fc]=_1fd;
rabbit.facade.setUserPref(key,_1fe);
},getFrameSpecificUserPref:function(_1ff,_200,key){
var _201=rabbit.facade.getUserPref(key);
if(_201[_1ff]&&_201[_1ff][_200]){
return _201[_1ff][_200];
}else{
return null;
}
},registerPrototypePref:function(key,_202){
rabbit.common.prefsManager.registerPrototypePref(key,_202);
},setPrototypePref:function(key,_203){
rabbit.common.prefsManager.setPrototypePref(key,_203);
},getPrototypePref:function(key){
return rabbit.common.prefsManager.getPrototypePref(key);
},setFrameSpecificPrototypePref:function(_204,_205,key,_206){
var _207=rabbit.util.cloneObject(rabbit.facade.getPrototypePref(key));
_207[_204]=_207[_204]||{};
_207[_204][_205]=_206;
rabbit.facade.setPrototypePref(key,_207);
},getFrameSpecificPrototypePref:function(_208,_209,key){
var _20a=rabbit.facade.getPrototypePref(key);
if(_20a[_208]&&_20a[_208][_209]){
return _20a[_208][_209];
}else{
return null;
}
},sendMessage:function(url,data,_20b){
if(rabbit.communication&&rabbit.communication.manager&&rabbit.communication.manager.sendMessage){
rabbit.communication.manager.sendMessage(url,data,_20b);
}
}};
rabbit.result={};
rabbit.ui={};
...
rabbit.plugins={};
rabbit.stencils={};
rabbit.util=_.extend(rabbit.util,{formatDate:function(_20c){
var diff=((new Date()).getTime()-_20c)/1000/60;
var date=new Date(_20c);
if(diff<2){
...
},isElementChildOfSelector:function(_20d,_20e){
return $(_20d).parents(_20e).length>0;
},userRole:null});
...
var _20f={};
var _210={};
return {registerOnEvent:function registerOnEvent(_211,_212,_213,_214){
if(typeof _211!=="string"||typeof _212!=="function"||typeof _213!=="object"){
throw "Invalid Arguments for registerOnEvent";
}
if(!_20f.hasOwnProperty(_211)){
_20f[_211]=[];
}
var data={"callback":_212,"thisArg":_213,"includeEventType":false};
if(_214){
data.includeEventType=true;
}
_20f[_211].push(data);
},registerOnCategoryEvent:function(_215,_216,_217){
if(typeof _215!=="string"||typeof _216!=="function"||typeof _217!=="object"){
throw "Invalid Arguments for registerOnEventForCategory";
}
if(!_210.hasOwnProperty(_215)){
_210[_215]=[];
}
var data={"callback":_216,"thisArg":_217,"includeEventType":true};
_210[_215].push(data);
console.log("ok for "+_215);
},raiseEvent:function raiseEvent(_218){
this._raiseCategoryEvent.apply(this,arguments);
this._raiseNormalEvent.apply(this,arguments);
},_raiseCategoryEvent:function raiseEvent(_219){
var _21a=_219.replace(/\..*$/,"");
if(_21a!=_219){
console.log("Try to raise catergory "+_21a);
var _21b=_210[_21a];
if(typeof _21b==="undefined"){
console.warn("No handler category for invoked eventType "+_219+" (category: "+_21a+")");
return;
}
...
},_raiseNormalEvent:function raiseEvent(_21c){
var _21d=_20f[_21c];
if(typeof _21d==="undefined"){
console.warn("No handler for invoked eventType "+_21c);
return;
}
...
},_raiseEvent:function(_21e,args){
var _21f=_21e.callback;
var _220=_21e.thisArg;
var _221=_21e.includeEventType;
...
},buildEditUrl:function(_222){
var _223="/rabbit/edit/"+rabbit.result.manager.currentPrototypeId+"#";
var _224="page/"+rabbit.result.manager.currentPageNr;
var _225="";
if(_222){
var page=rabbit.data.pageStore.objects[_222];
var _226=rabbit.data.folderStore.objects[page.data.parentFolder];
while(_226!==undefined){
_225="folder/"+_226.data.id+"/"+_225;
_226=rabbit.data.folderStore.objects[_226.data.parentFolder];
}
}
return _223+_225+_224;
},getUrl:function(name,_227){
var url=this.urls[name];
var _228=rabbit.result.manager.urlPattern;
...
if(name==="loadLayer"){
_228=rabbit.result.manager.urlPattern.replace("__page__","layer/__page__");
}
url=url.replace("__urlPattern__",_228);
if(_227){
for(var key in _227){
url=url.replace("__"+key+"__",_227[key]);
}
}
return url;
},sendMessage:function(url,data,_229){
this.post(rabbit.common.baseUrl+url,undefined,data,{complete:_229});
},get:function(url,_22a,data,_22b){
return this.ajax(url,"get",_22a,data,_22b);
},post:function(url,_22c,data,_22d){
return this.ajax(url,"post",_22c,data,_22d);
},ajax:function(url,type,_22e,data,_22f){
if(!url){
...
data=data||undefined;
_22f=_22f||{};
var _230=_.defaults({url:url,type:type,dataType:_22e,data:data},_22f);
return $.ajax(_230);
}};
rabbit.result.manager={datePickerClicked:false,customDatepickerObjects:[],init:function(_231,_232,_233,_234){
try{
...
rabbit.prototypeType=_232;
rabbit.browser=_233;
this.initialPageId=_231;
...
try{
var _236=rabbit.facade._availablePlugins[i];
_236.init.apply(_236,_236._initialArguments);
}
catch(e){
console.error(e);
}
...
},goToPage:function(_237,_238){
var url;
var page=rabbit.data.pageStore.objects[_237];
var _239=Boolean(_237.match(/^[a-zA-Z0-9]*$/));
if(_239){
url=rabbit.data.pageStore.getPageUrl(_237);
...
if(!_237.match(/^[a-zA-Z0-9]*:\/\//)){
url="http://"+_237;
}else{
url=_237;
}
}
if(!_239&&rabbit.facade.runningInApp()&&rabbit.facade.isIOS){
...
},showPage:function(_23a,_23b,_23c,_23d){
_23c=_23c||false;
var _23e=_23a.attr("id");
try{
if(_23b===""||_23b===this.currentPageNr){
return;
}
var page=rabbit.data.pageStore.objects[_23b];
console.log("show page repository:"+_23e+" page:"+_23b,page);
if(page===undefined){
this.goToPage(_23b);
return;
}
rabbit.ui.manager.showPage(_23a,_23b,_23d);
if(_23c===true&&this.isPushStateAvailable){
console.log("PUSH STATE",_23b);
window.history.pushState({repositoryId:_23e,pageId:_23b},"",rabbit.data.pageStore.getPageUrl(_23b));
}
this.currentPageNr=_23b;
_23a.data("page-id",_23b);
rabbit.event.manager.raiseEvent(rabbit.events.pageLoaded,page,_23a);
rabbit.mobile.trigger("pidoco:afterShowPage");
}
catch(e){
console.error(e);
}
},menuClick:function(a,b,_23f){
rabbit.result.manager.goToPage(_23f,false);
}};
...
},createWrappers:function(_240,_241,_242){
var _243=_240.find(">.wrapper.wrapper-"+_241);
if(!_243.length){
_243=$("<div data-layer-id=\""+_241+"\" id=\""+_240[0].id+"-"+_241+"-wrapper\" class=\"u-p-hidden wrapper wrapper-"+_241+"\"></div>").appendTo(_240);
}
var page=rabbit.data.pageStore.objects[_241];
if(_242===true&&page){
for(var name in page.data.layers){
if(page.data.layers[name]===true||page.data.layers[name]==="true"){
this.createWrappers(_240,name);
}
}
}
return _243;
},fillWrappersWithLayer:function(_244){
var _245=_244.data.id;
$(".wrapper-"+_245+"[data-fill-me=\"true\"]:empty").each(function(_246,_247){
this.fillWrapperWithLayer(_247,_244);
_247.removeAttribute("data-fill-me");
}.bind(this));
},fillWrapperWithLayer:function(_248,_249,_24a){
var _24b=_248.parentNode.id;
var html=_249.data.html;
if(html){
html=$(_249.data.html.replace(/__containerId__/g,_24b));
if(_24a){
html.find("script").remove();
}
$(_248).append(html);
if(!this.inTransition){
rabbit.facade.raiseEvent(rabbit.events.layerStoreInserted,_248.children[0]);
}
}else{
_248.setAttribute("data-fill-me","true");
}
return html;
},getLayerWrapper:function(_24c,_24d){
return _24c.find(">.wrapper-"+_24d);
},showLayer:function(_24e,_24f){
var _250=rabbit.data.layerStore.objects[_24f];
if(!_250){
rabbit.data.layerStore.loadLayer(_24f);
_250=rabbit.data.layerStore.objects[_24f];
}
var _251=this.getLayerWrapper(_24e,_24f);
if(!_251.length){
_251=this.createWrappers(_24e,_24f,true);
}
if(_251[0].children.length===0){
this.fillWrapperWithLayer(_251[0],_250);
}
_251.removeClass("u-p-hidden");
rabbit.event.manager.raiseEvent(rabbit.events.showLayer,{id:_24e.attr("id")+_24f,layerId:_24f,repositoryId:_24e.attr("id")});
},hideLayer:function(_252,_253){
rabbit.util.printStackTrace();
var _254=this.getLayerWrapper(_252,_253);
_254.addClass("u-p-hidden");
rabbit.event.manager.raiseEvent(rabbit.events.hideLayer,{id:_252.attr("id")+_253,layerId:_253,repositoryId:_252.attr("id")});
},toggleLayer:function(_255,_256){
var _257=this.getLayerWrapper(_255,_256);
if(!_257.length||_257.hasClass("u-p-hidden")){
return this.showLayer(_255,_256);
}else{
return this.hideLayer(_255,_256);
}
},showPage:function(_258,_259,_25a){
var _25b;
if(_25a==="fromRight"||_25a==="fromLeft"||_25a==="fromTop"||_25a==="fromBottom"){
_25b=this.showPageWithTranslation(_258,_259,_25a);
}else{
if(_25a==="opacity"){
_25b=this.showPageWithOpacity(_258,_259);
}else{
if(_25a==="flip"){
_25b=this.showPageWithFlip(_258,_259);
}else{
_25b=this.showPageWithoutTransition(_258,_259);
}
}
}
if(_258.attr("id")=="repository"&&_25b){
_25b.done(function(){
$(_258).attr("data-review-reference-id",_259);
$(_258).attr("data-page-id",_259);
$("body").attr("data-current-page-id",_259);
});
}
},showPageWithoutTransition:function(_25c,_25d){
var page=rabbit.data.pageStore.objects[_25d];
var _25e=new $.Deferred();
rabbit.ui.manager.showLayer(_25c,_25d);
_.each(page.data.layers,function(_25f,_260){
this.showLayer(_25c,_260);
}.bind(this));
_25c.find(">.wrapper:not(.u-p-hidden)").each(function(_261,_262){
var _263=_262.getAttribute("data-layer-id");
if((!page.data.layers.hasOwnProperty(_263)||page.data.layers[_263]!==true)&&_263!=_25d){
this.hideLayer(_25c,_263);
}
}.bind(this));
_25e.resolve();
return _25e.promise();
},showPageWithFlip:function(_264,_265){
var _266=500;
var _267=new $.Deferred();
this.startTransition(_264);
var _268=this.createTransitionWrapper(_264,_265);
var _269=_268.leave.find(">div");
var _26a=_268.enter.find(">div");
_264.find(">div").addClass("u-p-hidden");
_264.append(_268.leave).append(_268.enter);
_26a.addClass("u-p-hidden");
_269.transition({perspective:"0px",rotateY:"90deg",duration:_266},function(){
_26a.transition({perspective:"0px",rotate3d:"0,1,0,270deg",duration:0},function(){
_26a.removeClass("u-p-hidden");
this.showPageWithoutTransition(_26a,_265);
_26a.transition({perspective:"0px",rotate3d:"0,1,0,360deg",duration:_266},function(){
_269.transition({perspective:"0px",rotateY:"0deg",duration:0},function(){
this.stopTransition(_264);
this.showPageWithoutTransition(_264,_265);
_268.leave.remove();
_268.enter.remove();
_267.resolve();
}.bind(this));
...
return _267.promise();
},showPageWithOpacity:function(_26b,_26c){
var _26d=500;
var _26e=new $.Deferred();
this.startTransition(_26b);
var _26f=this.createTransitionWrapper(_26b,_26c);
var _270=_26f.leave.find(">div");
var _271=_26f.enter.find(">div");
_26b.find(">div").addClass("u-p-hidden");
_26b.append(_26f.leave).append(_26f.enter);
_271.css({opacity:0});
_270.transition({opacity:0,duration:_26d},function(){
this.showPageWithoutTransition(_271,_26c);
_271.transition({opacity:1,duration:_26d},function(){
this.stopTransition(_26b);
this.showPageWithoutTransition(_26b,_26c);
_26f.leave.remove();
_26f.enter.remove();
_26e.resolve();
}.bind(this));
...
return _26e.promise();
},showPageWithTranslation:function(_272,_273,_274){
var _275=_272.width();
var _276=_272.height();
var _277=500;
var _278=new $.Deferred();
this.startTransition(_272);
var _279=this.createTransitionWrapper(_272,_273);
var _27a=_279.leave.find(">div");
var _27b=_279.enter.find(">div");
if(_274==="fromLeft"){
_27b.css("left",-1*_275);
}else{
if(_274==="fromTop"){
_27b.css("top",-1*_276);
}else{
...
_27b.find(">div").removeClass("u-p-hidden");
_272.find(">div").addClass("u-p-hidden");
_272.append(_279.leave).append(_279.enter);
var _27c=function(){
this.stopTransition(_272);
this.showPageWithoutTransition(_272,_273);
_279.leave.remove();
_279.enter.remove();
_278.resolve();
}.bind(this);
if(_274==="fromLeft"){
_27a.transition({x:_275+"px",duration:_277});
_27b.transition({x:_275+"px",duration:_277},_27c);
}else{
if(_274==="fromTop"){
_27a.transition({y:_276+"px",duration:_277});
_27b.transition({y:_276+"px",duration:_277},_27c);
}else{
if(_274==="fromBottom"){
_27a.transition({y:"-"+_276+"px",duration:_277});
_27b.transition({y:"-"+_276+"px",duration:_277},_27c);
...
return _278.promise();
},createTransitionWrapper:function(_27d,_27e){
var _27f=_27d.data("page-id");
var _280=rabbit.data.pageStore.objects[_27e];
var _281=rabbit.data.pageStore.objects[_27f];
var _282,_283;
var _284=$("<div class=\"transition-wrapper transition-enter\" data-page-id=\""+_27e+"\"><div class=\"layer-container\"></div></div>");
var _285=$("<div class=\"transition-wrapper transition-leave\" data-page-id=\""+_27f+"\"><div class=\"layer-container\"></div></div>");
var _286=_285.find(">div");
var _287=_284.find(">div");
var _288=_27d.find(".wrapper-"+_27f).clone().remove("script");
var _289=_27d.find(".wrapper-"+_27e).clone().remove("script");
for(_282 in _280.data.layers){
_283=_280.data.layers[_282];
if(_283===true||_283==="true"){
this.createWrappers(_287,_282,false);
this.showLayer(_287,_282);
}
}
for(_282 in _281.data.layers){
_283=_281.data.layers[_282];
if(_283===true||_283==="true"){
this.createWrappers(_286,_282,false);
this.showLayer(_286,_282);
}
}
_286.append(_288);
if(_289.length===0){
_289=this.createWrappers(_287,_27e,true);
}else{
_287.append(_289);
}
if(_289.children().length===0){
this.fillWrapperWithLayer(_289[0],rabbit.data.layerStore.objects[_27e],true);
}
return {enter:_284,leave:_285};
},startTransition:function(_28a){
this.inTransition=true;
$("body").addClass("disable-pointer-events");
$(_28a).addClass("during-transition");
},stopTransition:function(_28b){
this.inTransition=false;
$("body").removeClass("disable-pointer-events");
$(_28b).removeClass("during-transition");
},_forceRedraw:function(){
var _28c=navigator.userAgent.toLowerCase().indexOf("chrome")>-1;
var _28d=navigator.userAgent.toLowerCase().indexOf("safari")>-1;
if(_28c||_28d){
...
rabbit.interaction.manager={tmp:{},actions:{click:{makeableOnDesktop:function(_28e){
return !_28e.numberOfFinger||_28e.numberOfFinger=="1"||_28e.numberOfFinger=="any";
},render:function(_28f){
if(parseInt(_28f.data.action.numberOfFinger,10)>1){
return t("interaction.action.multiFingerClick.userDescription").replace("__element__",rabbit.interaction.manager.getElementTitle(_28f));
}else{
return t("interaction.action.click.userDescription").replace("__element__",rabbit.interaction.manager.getElementTitle(_28f));
}
},defineEvent:function(_290){
var _291=document.getElementById(_290.data.stencilId);
if(_290.data.action.button=="right"){
$(_291).on("contextmenu",function(e){
rabbit.interaction.manager.raiseInteraction(_290,rabbit.interaction.manager.serializeEvent(e));
return false;
});
}else{
if(false){
...
var _294=200;
var _295=500;
_291.addEventListener("touchstart",function(e){
if(!_290.data.action.numberOfFinger||(_290.data.action.numberOfFinger&&(_290.data.action.numberOfFinger==="any"||parseInt(_290.data.action.numberOfFinger,10)===e.touches.length))){
_292=new Date().getTime();
}
e.preventDefault();
},false);
_291.addEventListener("touchend",function(e){
if(_292){
...
if(rabbit.interaction.manager.actions.click.makeableOnDesktop(_290.data.action)){
_291.addEventListener("click",function(e){
rabbit.interaction.manager.raiseInteraction(_290,rabbit.interaction.manager.serializeEvent(e));
});
}
}
}
}},doubleClick:{makeableOnDesktop:true,render:function(_296){
return t("interaction.action.doubleClick.userDescription").replace("__element__",rabbit.interaction.manager.getElementTitle(_296));
},defineEvent:function(_297){
var _298=document.getElementById(_297.data.stencilId);
if(_297.data.action.button=="right"){
$(_298).on("contextmenu",function(e){
rabbit.interaction.manager.raiseInteraction(_297,rabbit.interaction.manager.serializeEvent(e));
return false;
});
}else{
if(false){
...
var _29b=200;
var _29c=500;
_298.addEventListener("touchstart",function(e){
_299=new Date().getTime();
if(_29c<(_299-_29a)){
_29a=null;
}
e.preventDefault();
},false);
_298.addEventListener("touchend",function(e){
if(_299){
var end=new Date().getTime();
if(_29b>(end-_299)){
if(!_29a){
...
_298.addEventListener("dblclick",function(e){
rabbit.interaction.manager.raiseInteraction(_297,rabbit.interaction.manager.serializeEvent(e));
});
}
}
}},hover:{makeableOnDesktop:true,render:function(_29d){
return t("interaction.action.hover.userDescription").replace("__element__",rabbit.interaction.manager.getElementTitle(_29d));
},defineEvent:function(_29e){
if(!_29e.data.action.trigger){
_29e.data.action.trigger="enter";
}
if(_29e.data.action.trigger=="both"||_29e.data.action.trigger=="enter"){
$("#"+_29e.data.stencilId).on("mouseenter",function(e){
rabbit.interaction.manager.raiseInteraction(_29e,rabbit.interaction.manager.serializeEvent(e));
});
}
if(_29e.data.action.trigger=="both"||_29e.data.action.trigger=="leave"){
$("#"+_29e.data.stencilId).on("mouseleave",function(e){
rabbit.interaction.manager.raiseInteraction(_29e,rabbit.interaction.manager.serializeEvent(e));
});
}
}},swipe:{makeableOnDesktop:false,render:function(_29f){
return t("interaction.action.swipe.userDescription").replace("__element__",rabbit.interaction.manager.getElementTitle(_29f));
},defineEvent:function(_2a0){
var _2a1=Hammer(document.getElementById(_2a0.data.stencilId),{swipe_max_touches:5,drag_block_horizontal:true,drag_block_vertical:true,swipe_velocity:0.4});
_2a1.on("swipe",function(e){
if(_2a0.data.action.direction==="any"||e.gesture.direction===_2a0.data.action.direction){
rabbit.facade.markHighlightTouchesAsSuccessful();
rabbit.interaction.manager.raiseInteraction(_2a0,rabbit.interaction.manager.serializeEvent(e));
}
});
}},pinch:{makeableOnDesktop:false,render:function(_2a2){
return t("interaction.action.pinch.userDescription").replace("__element__",rabbit.interaction.manager.getElementTitle(_2a2));
},defineEvent:function(_2a3){
var _2a4=Hammer(document.getElementById(_2a3.data.stencilId),{prevent_default:true});
var _2a5=null;
var _2a6=false;
if(_2a3.data.action.direction==="in"){
_2a5="pinchin";
}else{
if(_2a3.data.action.direction==="out"){
_2a5="pinchout";
}else{
_2a5="pinch";
}
}
_2a4.on("transformstart",function(e){
_2a6=false;
});
_2a4.on("transformend",function(e){
if(_2a6){
rabbit.facade.markHighlightTouchesAsSuccessful();
rabbit.interaction.manager.raiseInteraction(_2a3,rabbit.interaction.manager.serializeEvent(e));
}
});
_2a4.on(_2a5,function(e){
_2a6=true;
});
}}},getInterinteractionEventId:function(_2a7){
return "interaction."+_2a7;
},raiseInteraction:function(_2a8,e){
if(this.isInteractionExecutable(_2a8)){
rabbit.facade.raiseEvent(_2a8.data.uniqueId,e);
return true;
}else{
return false;
}
},isLayerHidden:function(_2a9){
return $(_2a9).css("display")==="none";
},isInteractionExecutable:function(_2aa){
var _2ab=$("#"+_2aa.data.stencilId);
var _2ac=_2ab.parents(".layer");
for(var i=0;i<_2ac.length;i++){
if(this.isLayerHidden(_2ac.get(i))){
return false;
}
}
if(_2ab.length===0||_2ab.hasClass("layer")&&this.isLayerHidden(_2ab)){
return false;
}
return true;
},renderAction:function(_2ad){
return rabbit.interaction.manager.actions[_2ad.data.action.type].render(_2ad);
},getElementTitle:function(_2ae){
var type=$("#"+_2ae.data.stencilId).data("interactive-element-type");
return t("stencils."+type+"-palette");
},registerAction:function(name,_2af){
if(_.has(rabbit.interaction.manager.actions,name)){
throw "Action with name "+name+" already exists.";
}else{
rabbit.interaction.manager.actions[name]=_2af;
}
},registerReaction:function(name,_2b0){
if(_.has(rabbit.interaction.manager.reactions,name)){
throw "Action with name "+name+" already exists.";
}else{
rabbit.interaction.manager.reactions[name]=_2b0;
}
},reactions:{showPage:{init:function(_2b1,_2b2){
var _2b3=rabbit.interaction.manager.reactions.showPage.getOpeningMethod(_2b2);
if(_2b3==="withoutReloadOnly"||_2b3==="withoutReloadIframe"){
rabbit.facade.loadLayer(_2b2.target);
}
},getOpeningMethod:function(_2b4){
var _2b5=_2b4.options;
if(!_2b5){
if(_2b4.inNewTab==="true"){
_2b5="reloadNewTab";
}else{
if(_2b4.withoutReload=="true"){
_2b5="withoutReloadOnly";
}else{
if(_2b4.withoutReload!==undefined){
_2b5="reloadOnly";
}
}
}
...
return _2b5;
},callback:function(_2b6,_2b7,_2b8){
var _2b9=_2b8.target;
if(!_2b9){
return;
}
var _2ba=rabbit.interaction.manager.reactions.showPage.getOpeningMethod(_2b8);
if(_2ba==="reloadNewTab"){
rabbit.result.manager.goToPage(_2b9,true);
}else{
if(_2ba==="withoutReloadOnly"){
rabbit.facade.showPage($("#repository"),_2b9,true,_2b8.transition);
}else{
if(_2ba==="withoutReloadIframe"){
var _2bb=document.getElementById(_2b7.data.stencilId);
var _2bc=rabbit.facade.getRepositoryFromStencil(_2bb);
var _2bd=false;
if(_2bc.attr("id")==="repository"){
_2bd=true;
}
rabbit.facade.showPage(_2bc,_2b9,_2bd,_2b8.transition);
}else{
rabbit.result.manager.goToPage(_2b9);
}
}
}
}},toggleLayer:{init:function(_2be,_2bf){
rabbit.facade.loadLayer(_2bf.layer);
},callback:function(_2c0,_2c1,_2c2){
var _2c3=document.getElementById(_2c1.data.stencilId);
var _2c4=rabbit.facade.getRepositoryFromStencil(_2c3);
if(_2c2.visibility==="toggle"){
rabbit.facade.toggleLayer(_2c4,_2c2.layer);
}else{
if(_2c2.visibility==="show"){
rabbit.facade.showLayer(_2c4,_2c2.layer);
}else{
if(_2c2.visibility==="hide"){
rabbit.facade.hideLayer(_2c4,_2c2.layer);
}
}
}
}},vibrate:{callback:function(_2c5,_2c6,_2c7){
navigator.vibrate=navigator.vibrate||navigator.mozVibrate||navigator.webkitVibrate||undefined;
if(navigator.vibrate){
navigator.vibrate(_2c7.duration);
}else{
if(window.parentBody){
window.parentBody.trigger("pidoco:vibrate",[{duration:_2c7.duration}]);
}else{
}
}
}},browserBack:{callback:function(_2c8,_2c9,_2ca){
rabbit.facade.browserBack();
}},browserForward:{callback:function(_2cb,_2cc,_2cd){
rabbit.facade.browserForward();
}},closeBrowserWindow:{callback:function(_2ce,_2cf,_2d0){
rabbit.facade.closeBrowserWindow();
}}},registerInteraction:function(_2d1,_2d2,_2d3,_2d4){
if(_2d1[0]==="-"){
return;
}
if(!_.isArray(_2d4)){
...
var _2d5=new rabbit.data.Interaction(_2d1,_2d2,_2d3,_2d4);
_2d5.initializeAction();
_2d5.initializeReactions();
rabbit.facade.raiseEvent(rabbit.events.newInteractionRegistered,_2d5);
},serializeEvent:function(e){
return {};
}};
rabbit.mobile={bind:function(_2d6,_2d7){
if(rabbit.facade.runningInApp()){
document.addEventListener(_2d6,_2d7);
}
},unbind:function(_2d8,_2d9){
if(rabbit.facade.runningInApp()){
document.removeEventListener(_2d8,_2d9);
}
},trigger:function(_2da,data){
if(rabbit.facade.runningInApp()){
window.parentBody.trigger(_2da,data);
}
}};
rabbit.facade=_.extend(rabbit.facade,function _returnFacade(){
var _2db=rabbit.event.manager;
return {_availablePlugins:[],vml:false,isIOS:navigator.userAgent.match(/iPad|iPhone/),isAndroid:navigator.userAgent.match(/Android/),scaleFactor:1,registerPlugin:function registerPlugin(_2dc,_2dd){
try{
var _2de=Array.prototype.slice.call(arguments);
_2de.shift();
_2dc._initialArguments=_2de;
this._availablePlugins.push(_2dc);
}
catch(e){
console.log(e);
}
},setScaleFactor:function(_2df){
this.scaleFactor=_2df;
},getScaleFactor:function(){
return this.scaleFactor;
},isFrameDisplayed:false,registerOnEvent:function registerOnEvent(_2e0,_2e1,_2e2){
try{
if(_.isArray(_2e0)){
for(var i=0;i<_2e0.length;i++){
console.debug("Registering a handler for "+_2e0[i]);
_2db.registerOnEvent(_2e0[i],_2e1,_2e2,true);
}
}else{
if(_.isString(_2e0)){
console.debug("Registering a handler for "+arguments[0]);
_2db.registerOnEvent(_2e0,_2e1,_2e2,false);
}
}
}
catch(e){
...
},registerOnCategoryEvent:function(_2e3,_2e4,_2e5){
try{
_2db.registerOnCategoryEvent(_2e3,_2e4,_2e5,true);
}
catch(e){
console.error(e);
return undefined;
}
},raiseEvent:function raiseEvent(_2e6){
console.debug("Raising a "+arguments[0]+" event");
try{
return _2db.raiseEvent.apply(_2db,arguments);
}
catch(e){
console.error(e);
return undefined;
}
},fireMouseOn:function fireMouseOn(_2e7){
var _2e8=document.getElementById(_2e7);
if(_2e8===null){
return;
}
console.debug("Forwarding a click event to "+_2e7);
_2e8.click();
_2e8.focus();
},showPage:function(){
...
window.close();
},getLayerFromStencil:function(_2ea){
return $(_2ea).closest(".layer");
},getRepositoryFromStencil:function(_2eb){
return $(_2eb).closest(".repository");
},isExport:function(){
...
},"alert":function(_2ef,text,_2f0){
rabbit.plugins.systemAlert.alert(_2ef,text,_2f0);
}};
}());
...
},loadLayer:function(_2f1){
var ajax;
if(typeof this.objects[_2f1]==="undefined"){
var url=null;
if(rabbit.result.manager.isExport){
var _2f2=(rabbit.browser==="ie")?"-ie":"";
url=rabbit.communication.manager.getUrl("loadLayerExport",{layerId:_2f1,browser:_2f2,mode:rabbit.util.getMode()});
}else{
url=rabbit.communication.manager.getUrl("loadLayer",{prototypeId:rabbit.result.manager.currentPrototypeId,layer:_2f1});
}
var _2f3=(rabbit.result.manager.isExport)?"jsonp":"html";
ajax=rabbit.communication.manager.get(url,_2f3,{containerId:"__containerId__",mode:rabbit.util.getMode(),viewMode:rabbit.parameters.viewMode,fontFamily:rabbit.parameters.fontFamily},{crossDomain:rabbit.result.manager.isExport});
if(!rabbit.result.manager.isExport){
ajax.done(this.addLayerFromHtml.bind(this));
}
this.objects[_2f1]=new rabbit.data.Layer(_2f1,null,null);
}else{
...
var _2f4=$($.trim(html));
var _2f5=_2f4.find("#result");
$(_2f5).children().each(function(_2f6,_2f7){
_2f7=$(_2f7);
var _2f8=_2f7.data("layer-id");
var _2f9=_2f7.data("layer-type");
var html=$.trim(_2f7[0].outerHTML);
if(this.objects[_2f8]){
this.objects[_2f8].data.id=_2f8;
this.objects[_2f8].data.layerType=_2f9;
this.objects[_2f8].data.html=html;
}else{
this.objects[_2f8]=new rabbit.data.Layer(_2f8,_2f9,html);
}
rabbit.facade.raiseEvent(rabbit.events.layerLoaded,this.objects[_2f8]);
}.bind(this));
_2f4.find("#border-wrapper > div").prependTo(".border-wrapper");
_2f4.find("#styles > style").appendTo("body");
var _2fa=_2f4.find("#json").text();
if(_2fa){
var _2fb=JSON.parse(_2fa);
rabbit.data.pageStore.addPage(_2fb);
}
}};
rabbit.data.Layer=rabbit.util.Class(rabbit.data.Base,function(sup){
this.init=function(id,_2fc,html){
this.data={id:id,layerType:_2fc,html:html};
};
});
rabbit.data.pageStore={objects:{},init:function(){
var _2fd=$("#pageNames").html();
if((_2fd!==null)&&(_2fd!=="__pageNames__")){
_2fd=JSON.parse(_2fd);
}
var _2fe=rabbit.data.raw.pages;
for(var id in _2fe){
this.addPage(_2fe[id]);
}
rabbit.event.manager.raiseEvent(rabbit.events.pageStoreLoaded);
},addPage:function(_2ff){
this.objects[_2ff.id]=new rabbit.data.Page(_2ff);
...
var _300=rabbit.data.raw.folders;
for(var id in _300){
this.objects[id]=new rabbit.data.Folder(_.extend(_300[id],{id:id}));
}
...
this.init=function(_301,_302,_303,_304){
this.data={stencilId:_301,interactionId:_302,uniqueId:_301+"-"+_302,action:_303,reactions:_304};
};
...
_.each(this.data.reactions,function(_305){
if(!_.has(rabbit.interaction.manager.reactions,_305.type)){
console.error("Reaction \""+_305.type+"\" is not supported");
return;
}
var init=rabbit.interaction.manager.reactions[_305.type].init;
if(typeof init==="function"){
init(this,_305);
}
}.bind(this));
rabbit.facade.registerOnEvent(this.data.uniqueId,function(e){
_.each(this.data.reactions,function(_306){
var _307=parseInt(_306.delay,10)||0;
setTimeout(function(){
rabbit.interaction.manager.reactions[_306.type].callback(e,this,_306);
}.bind(this),_307);
}.bind(this));
...
},createDiscussion:function(_308,_309,x,y,data){
var url=rabbit.communication.manager.getUrl("createDiscussion",{layerId:_308});
data=data||{};
data=_.defaults(data,{title:_309,x:x,y:y,pageX:x,pageY:y,referenceId:rabbit.facade.getCurrentPageId(),pageId:rabbit.facade.getCurrentPageId(),layerContainerId:rabbit.facade.getCurrentPageId()});
return rabbit.data.discussionStore.callAjax(url,data);
},deleteDiscussion:function(_30a){
delete this.objects[_30a.data.id];
var url=rabbit.communication.manager.getUrl("deleteDiscussion",{layerId:_30a.data.layerId});
return this.callAjax(url,{discussion:_30a.data.id});
},flush:function(){
this.objects={};
rabbit.event.manager.raiseEvent(rabbit.events.discussionStoreChanged);
},getFromLayer:function(_30b){
var url=rabbit.communication.manager.getUrl("getDiscussions",{layerId:_30b});
...
var _30c=this.objects[id];
if(_30c){
_30c.setData(data.discussions[id]);
}else{
_30c=new rabbit.data.Discussion();
_30c.setData(data.discussions[id]);
this.objects[id]=_30c;
}
}
...
this.move=function(x,y,_30d,_30e,_30f,_310,_311,_312){
this.data.x=x;
this.data.y=y;
this.data.pageX=_30d;
this.data.pageY=_30e;
this.data.referenceId=_30f;
this.data.pageId=_310;
this.data.layerId=_311;
this.data.layerContainerId=_312;
var url=rabbit.communication.manager.getUrl("moveDiscussion",{layerId:this.data.layerId});
return rabbit.data.discussionStore.callAjax(url,{discussion:this.data.id,x:Math.floor(x),y:Math.floor(y),pageX:Math.floor(_30d),pageY:Math.floor(_30e),referenceId:_30f,pageId:_310,layerId:_311,layerContainerId:_312});
};
this.rename=function(_313){
if(this.data.title===_313){
return;
}
var _314=this.data.title;
this.data.title=_313;
...
var _315=t("result.discussion.title-changed").replace("__oldTitle__",_314).replace("__newTitle__",_313);
this.addEntry(_315);
return ajax;
};
...
this.setState=function(_316){
var url=rabbit.communication.manager.getUrl("setStateDiscussion",{layerId:this.data.layerId});
return rabbit.data.discussionStore.callAjax(url,{discussion:this.data.id,state:_316});
};
});
...
var _317=rabbit.facade;
return {init:function init(){
},adjustBackgroundImage:function adjustBackgroundImage(_318){
var _319=document.getElementById("borderDiv");
_319.style.width=_318.data.width+"px";
_319.style.height=_318.data.height+"px";
var _31a=document.getElementById("repositorybackground");
_31a.setAttribute("width",_318.data.width);
_31a.setAttribute("height",_318.data.height);
_31a.setAttribute("style","width:"+_318.data.width+"px;height:"+_318.data.height+"px;");
this._replaceBackgroundImage(_318);
},_replaceBackgroundImage:function _replaceBackgroundImage(_31b){
var _31c,_31d;
if(!_317.vml){
_31c=document.getElementById("repositorybackground");
_31d=_31c.getElementsByTagNameNS("http://www.w3.org/2000/svg","image")[0];
_31d.setAttribute("width",_31b.data.width);
_31d.setAttribute("height",_31b.data.height);
if(_31b.data.image!==""){
_31d.setAttribute("display","inherit");
_31d.setAttributeNS("http://www.w3.org/1999/xlink","href",_31b.data.image);
}else{
_31d.setAttribute("display","none");
_31d.removeAttributeNS("http://www.w3.org/1999/xlink","href");
}
}else{
_31c=document.getElementById("repositorybackground");
_31d=document.createElement("img");
_31d.style.width="";
_31d.style.height="";
_31d.setAttribute("src",_31b.data.image.replace(/_(\d)+\Z/,""));
_31c.replaceChild(_31d,_31c.firstChild);
if(_31b.data.image===""){
_31d.style.display="none";
}else{
_31d.style.display="inline";
this._adjustBackgroundImgSize(_31b.data.width,_31b.data.height);
}
}
},_adjustBackgroundImgSize:function _adjustBackgroundImgSize(_31e,_31f){
if(!document.images[0].complete){
window.setTimeout("rabbit.plugins.background._adjustBackgroundImgSize("+_31e+", "+_31f+");",100);
return;
}
var _320=document.images[0].width;
var _321=document.images[0].height;
if(_320/_321>_31e/_31f){
document.images[0].width=_31e;
document.images[0].height=_321*_31e/_320;
}else{
document.images[0].width=_320*_31f/_321;
document.images[0].height=_31f;
}
}};
}();
rabbit.facade.registerPlugin(rabbit.plugins.background);
rabbit.plugins.gps=function(){
var _322=rabbit.facade;
var _323={};
var _324=[];
var _325={nyc:{latitude:40.714353,longitude:-74.005973},paris:{latitude:48.856614,longitude:2.352222},pidoco:{latitude:52.509561,longitude:13.451579},warschauer60:{latitude:52.509754,longitude:13.451715},alexanderplatz:{latitude:52.521832,longitude:13.413168}};
return {trackPositionWithJavaScript:true,trackPosition:false,init:function init(){
this.startTrackPositon();
_322.registerOnEvent("positionChanged",this.positionChanged,this);
_322.registerAction("gps",{availableOnDesktop:false,init:function(){
rabbit.plugins.gps.trackPosition=true;
},render:function(_326){
if(_326.trigger==="both"){
return t("interaction.action.gps.userDescription.both");
}else{
if(_326.trigger==="enter"){
return t("interaction.action.gps.userDescription.enter");
}else{
if(_326.trigger==="leave"){
return t("interaction.action.gps.userDescription.leave");
}
}
}
},defineEvent:function(_327){
var area=JSON.parse(_327.data.action.area);
rabbit.plugins.gps.registerMoveInOutZone(area.latitude,area.longitude,area.distance,_327.data.action.trigger,function(e){
rabbit.interaction.manager.raiseInteraction(_327,e);
});
}});
...
navigator.geolocation.getCurrentPosition(function(_32b){
rabbit.plugins.gps.positionChanged(_32b.coords);
_328=setInterval(_32a,_329);
},function(){
console.log("ERROR GPS!");
},{maximumAge:_329,enableHighAccuracy:true,timeout:10000});
}
clearInterval(_328);
}
};
...
this.positionChanged({latitude:_325[name].latitude,longitude:_325[name].longitude});
},registerMoveInOutZone:function(_32c,_32d,_32e,_32f,_330){
_324.push({latitude:_32c,longitude:_32d,distance:_32e,callback:_330,trigger:_32f,wasInArea:false});
},positionChanged:function(_331){
for(var i=0;i<_324.length;i++){
var area=_324[i];
var _332=this.isPositionInArea(_331,area);
if(_332&&!area.wasInArea&&area.trigger==="enter"||!_332&&area.wasInArea&&area.trigger==="leave"||_332!==area.wasInArea&&area.trigger==="both"){
area.callback();
}
area.wasInArea=_332;
}
},isPositionInArea:function(_333,area){
return this.calculateDistance(_333.latitude,_333.longitude,area.latitude,area.longitude)<area.distance;
},calculateDistance:function(lat1,lon1,lat2,lon2){
var _334=function(deg){
return deg*(Math.PI/180);
};
var R=6371;
var dLat=_334(lat2-lat1);
var dLon=_334(lon2-lon1);
var a=Math.sin(dLat/2)*Math.sin(dLat/2)+Math.cos(_334(lat1))*Math.cos(_334(lat2))*Math.sin(dLon/2)*Math.sin(dLon/2);
...
var _335=rabbit.facade;
return {init:function(){
_335.registerAction("keypress",{makeableOnDesktop:true,render:function(_336){
return t("interaction.action.keypress.userDescription");
},defineEvent:function(_337){
var _338=_337.data.action.sequence;
if(_338){
Mousetrap.bind(_338,function(){
rabbit.interaction.manager.raiseInteraction(_337,{});
});
}
}});
}};
...
var _339=rabbit.facade;
return {audiofiles:{},audios:{},init:function(){
_339.registerReaction("sound",{init:function(_33a,_33b){
if(!window.Audio){
return;
}
var id=_33b.soundUploader;
...
},callback:function(_33c,_33d,_33e){
var _33f=rabbit.plugins.sound.audiofiles[_33e.soundUploader];
if(!_33f){
return;
}
_33f.play();
...
var _340=rabbit.facade;
return {init:function(){
_340.registerReaction("systemAlert",{callback:function(_341,_342,_343){
this.alert(_343.title,_343.text,_343.buttonName);
}.bind(this)});
},alert:function(_344,text,_345){
if(_340.runningInApp()){
rabbit.facade.mobile.trigger("pidoco:systemAlert",{title:_344,text:text,buttonName:_345});
}else{
alert(text);
}
}};
...
var _346=rabbit.facade;
return {init:function(){
_346.registerAction("flip",{makeableOnDesktop:false,render:function(_347){
return t("interaction.action.flip.userDescription");
},defineEvent:function(_348){
new Fliptiltshake("flip",function(){
rabbit.interaction.manager.raiseInteraction(_348,{});
});
Fliptiltshake.start();
}});
}};
...
_349.registerAction("tilt",{makeableOnDesktop:false,render:function(_34a){
return t("interaction.action.tilt.userDescription");
},defineEvent:function(_34b){
new Fliptiltshake("tilt",{rotation:_34b.data.action.rotation,direction:(_34b.data.action.direction==="both")?null:_34b.data.action.direction,angle:_34b.data.action.angle,callback:function(){
if(rabbit.plugins.tilt.paused){
return;
}
var _34c=rabbit.interaction.manager.raiseInteraction(_34b,{});
if(_34c){
...
var _34d=rabbit.facade;
return {init:function(){
_34d.registerAction("shake",{makeableOnDesktop:false,render:function(_34e){
return t("interaction.action.shake.userDescription");
},defineEvent:function(_34f){
var _350=(_34d.isIOS)?_34f.data.action.intensity:_34f.data.action.intensity*10;
new Fliptiltshake("shake",{threshold:_350,durationMin:_34f.data.action.duration,callback:function(){
rabbit.interaction.manager.raiseInteraction(_34f,{});
}});
Fliptiltshake.start();
}});
}};
...
_351.registerAction("orientation",{makeableOnDesktop:false,render:function(_353){
var _354=_353.data.action;
if(_354.direction==="portrait"){
...
},defineEvent:function(_355){
_351.registerOnEvent("orientationChanged",function(_356){
if(_355.data.action.direction==_356){
rabbit.interaction.manager.raiseInteraction(_355,{});
}
},this);
}});
},orientationChanged:function(_357){
var _358=(_357===90||_357===-90)?"landscape":"portrait";
if(_352!=_358){
_352=_358;
_351.raiseEvent("orientationChanged",_358);
}
}};
}();
...
},frameChanged:function(_359,_35a){
var top=0,left=0;
if(rabbit.facade.isFrameDisplayed){
left=rabbit.common.frames[_359][_35a].frameBorderLeft;
top=rabbit.common.frames[_359][_35a].frameBorderTop;
}
this.container.css({left:left,top:top});
},newInteractionRegistered:function(_35b){
var _35c=_35b.data.action;
var _35d=typeof rabbit.interaction.manager.actions[_35c.type].makeableOnDesktop==="function"?rabbit.interaction.manager.actions[_35c.type].makeableOnDesktop(_35c):rabbit.interaction.manager.actions[_35c.type].makeableOnDesktop;
if(_35d){
return;
}
if(this.interactions[_35b.data.uniqueId]){
return;
}
var _35e=_35b.data.stencilId;
var _35f=document.getElementById(_35e);
if($(_35f).parents(".transition-wrapper:first").length){
return;
}
var _360=$(_35f).closest(".mobile-interaction-potential-trigger");
var _361=_360.attr("id");
var _362=$(_360).position();
var _363=true;
if($(_35f).hasClass("layer")){
_363=false;
}
var _364=this.triggerGroups[_361];
if(!_364){
_364=$("<div class=\"mobile-interactions-trigger-group-"+_361+" mobile-interactions-trigger-group\" data-trigger-id=\""+_361+"\"></div>");
this.triggerGroups[_361]=_364;
$(_360).mouseenter(function(e){
this.displayInteractions(_364);
return false;
}.bind(this)).mouseleave(function(e){
this.hideAllInteractions();
if(_363){
var id=$(_35f).closest(".repository").attr("id");
this.displayInteractions($(".mobile-interactions-trigger-group-"+id));
}
return false;
}.bind(this));
_364.data("fromStencil",_363);
if(_363){
$(_35f).append(_364);
}else{
var _365=$(_35f).parent()&&$(_35f).parent().parent()&&$(_35f).parent().parent().parent()&&$(_35f).parent().parent().parent().hasClass("renderIntern");
if(_365){
$(_35f).parent().parent().parent().parent().append(_364);
}else{
this.container.append(_364);
}
}
_364.css({left:0,top:-27/rabbit.facade.getScaleFactor()});
$(_364).mouseenter(function(e){
this.displayInteractions(_364);
return false;
}.bind(this)).mouseleave(function(e){
this.hideAllInteractions();
...
var _366=$("<div class=\"active interaction-trigger interaction-trigger-"+_35b.data.uniqueId+" interaction-trigger-"+_35c.type+"\" title=\""+t("interaction-trigger-"+_35b.data.action.type+"-tooltip")+"\">"+t("trigger-label-"+_35c.type)+"</div>");
if(!_363){
_366.addClass("interaction-trigger-layer-"+_35e.replace("-layer",""));
}
_366.click(function(){
rabbit.facade.raiseInteraction(_35b);
this.hideAllInteractions();
}.bind(this));
_364.append(_366);
this.interactions[_35b.data.uniqueId]=_35b;
},hideAllInteractions:function(){
$(".mobile-interactions-trigger-group").removeClass("visible");
},displayInteractions:function(_367){
$(".mobile-interactions-trigger-group").removeClass("visible");
$(_367).addClass("visible");
...
},pageLoaded:function(page,_368){
this.changeLinks(page.data.id);
},changeLinks:function(_369){
var _36a=rabbit.communication.manager.buildEditUrl(rabbit.result.manager.currentPageNr);
var _36b=rabbit.facade.getUrlPattern().replace("__page__",_369);
var _36c=_36b.replace(this.mode,"sketched").replace("?fontFamily=arial","");
var _36d=_36b.replace(this.mode,"sketchedArial");
var _36e=_36b.replace(this.mode,"plain").replace("?fontFamily=arial","");
this.toolbar.find(".edit-btn").attr("href",_36a);
this.toolbar.find(".sketched-btn").attr("href",_36c);
this.toolbar.find(".sketched-arial-btn").attr("href",_36d);
this.toolbar.find(".plain-btn").attr("href",_36e);
}};
...
rabbit.facade.registerReaction("showOverlay",{init:function(_36f,_370){
this.prepareOverlay(_36f.data.uniqueId,_370.target);
}.bind(this),callback:function(_371,_372,_373){
this.showOverlay(_372.data.uniqueId,_373.target);
}.bind(this)});
rabbit.facade.registerReaction("hideOverlay",{callback:function(_374,_375,_376){
this.hideOverlay();
}.bind(this)});
this.overlayContainer=$("body");
},getOrCreateOverlayRepository:function(_377,page){
var _378=this.overlayContainer.find("> div[data-page-id=\""+page.data.id+"\"]");
if(!_378.length){
_378=$("<div></div>");
_378.addClass("overlay").addClass("repository").attr("data-original-layer-id",page.data.id).attr("id","overlay-"+_377).attr("data-page-id",page.data.id).attr("data-apply-scale-factor","").appendTo(this.overlayContainer).css({width:page.data.width+"px",height:page.data.height+"px"}).data("has-rectangle",false);
}
return _378;
},prepareOverlay:function(_379,_37a){
var ajax=rabbit.facade.loadLayer(_37a);
ajax.done(function(){
var page=rabbit.data.pageStore.objects[_37a];
if(page){
var _37b=this.getOrCreateOverlayRepository(_379,page);
this.loadRectangle(page.data.width,page.data.height);
rabbit.ui.manager.createWrappers(_37b,_37a,true);
}
}.bind(this));
},loadRectangle:function(_37c,_37d){
if(this.hasRectangle(_37c,_37d)){
return;
}
if(rabbit.result.manager.isExport){
var _37e=(rabbit.browser==="ie")?"-ie":"";
url=rabbit.communication.manager.getUrl("rectangleExport",{height:_37d,width:_37c,mode:rabbit.util.getMode()});
...
ajax=rabbit.communication.manager.get(url,"html",{height:_37d,width:_37c});
ajax.success(function(html){
var _37f=$(html).children().first();
this.setRectangle(_37c,_37d,_37f);
}.bind(this));
}
},setRectangle:function(_380,_381,html){
this.rectangles[_380+"x"+_381]=html;
},getRectangle:function(_382,_383){
return $(this.rectangles[_382+"x"+_383]).clone();
},hasRectangle:function(_384,_385){
return typeof this.rectangles[_384+"x"+_385]!=="undefined";
},showOverlayBackground:function(){
$(".overlay-background").show();
},hideOverlayBackground:function(){
$(".overlay-background").hide();
},showOverlay:function(_386,_387){
var id="overlay-"+_386;
var page=rabbit.data.pageStore.objects[_387];
var _388=rabbit.facade.getCurrentPage();
var _389=this.getOrCreateOverlayRepository(_386,page);
if(page){
var _38a=page.data.width;
var _38b=page.data.height;
if(!_389.data("has-rectangle")){
_389.append(this.getRectangle(_38a,_38b));
_389.data("has-rectangle",true);
}
var _38c=$(document).height()>$(window).height();
if(rabbit.facade.isFrameDisplayed&&_38c){
var _38d=$(".border-wrapper")[0].getBoundingClientRect();
var top=_38d.top+_38d.height/2-parseInt(_38b)/2+window.scrollY;
var left=_38d.left+_38d.width/2-parseInt(_38a)/2+window.scrollX;
}else{
top=$(window).height()/2+window.scrollY-parseInt(_38b)/2;
left=$(window).width()/2+window.scrollX-parseInt(_38a)/2;
}
_389.appendTo(this.overlayContainer).show().css({top:top,left:left,transform:"scale("+rabbit.facade.getScaleFactor()+", "+rabbit.facade.getScaleFactor()+")"});
rabbit.ui.manager.showPage(_389,_387);
this.showOverlayBackground();
this.shownOverlays.push(_389);
}else{
}
},hideOverlay:function(){
var _38e=this.shownOverlays.pop();
_38e.hide();
this.hideOverlayBackground();
}};
rabbit.facade.registerPlugin(rabbit.plugins.overlay);
rabbit.plugins.scrollTo=function(){
var _38f=rabbit.facade;
return {init:function(){
_38f.registerReaction("scrollTo",{callback:function(_390,_391,_392){
this.scrollTo(_392.position,_392.duration);
}.bind(this)});
},scrollTo:function(_393,_394){
var _395=$("html, body");
var _396=$(".border-wrapper");
if(rabbit.facade.isFrameDisplayed&&_396[0].scrollHeight>_396.height()){
_395=_396;
}
if(_393==="bottom"){
_395.animate({scrollTop:_395[0].scrollHeight},parseInt(_394));
}else{
_395.animate({scrollTop:0},parseInt(_394));
}
}};
}();
rabbit.facade.registerPlugin(rabbit.plugins.scrollTo);
rabbit.plugins.startDialer={shownOverlays:[],rectangles:{},init:function(){
rabbit.facade.registerReaction("startDialer",{callback:function(_397,_398,_399){
this.startDialer(_399.phoneNumber);
}.bind(this)});
},startDialer:function(_39a){
window.location.href="tel:"+_39a;
}};
...
var _39b=e.targetTouches[i];
var _39c=this.makeCircle(_39b.pageX-this.offset.left,_39b.pageY-this.offset.top);
this.touchViewer[0].appendChild(_39c);
}
e.preventDefault();
},touchEndListener:function(){
setTimeout(function(){
var _39d=this.touchViewer.find("div");
_39d.each(function(){
...
var _39e=this.touchViewer.find("div");
_39e.each(function(){
...
var _39f=document.getElementsByClassName("touch");
for(var i=0;i<_39f.length;i++){
_39f[i].setAttribute("class",_39f[i].getAttribute("class")+" touch-success");
}
}};
}();
rabbit.facade.registerPlugin(rabbit.plugins.gestureHighlight);
rabbit.plugins.hold={init:function(){
rabbit.facade.registerAction("hold",{makeableOnDesktop:true,render:function(_3a0){
return t("interaction.action.hold.userDescription");
},defineEvent:function(_3a1){
var _3a2=Hammer(document.getElementById(_3a1.data.stencilId),{hold_timeout:_3a1.data.action.timeout});
_3a2.on("hold",function(e){
rabbit.interaction.manager.raiseInteraction(_3a1,{});
});
}});
}};
rabbit.facade.registerPlugin(rabbit.plugins.hold);
rabbit.plugins.valueChanged={listenedGroups:{},init:function(){
rabbit.facade.registerAction("booleanValueChanged",{makeableOnDesktop:true,render:function(_3a3){
return t("interaction.action.booleanValueChanged.userDescription");
},defineEvent:function(_3a4){
var _3a5=_3a4.data.stencilId;
var _3a6=$("#"+_3a5);
if(_3a6.hasClass("radiobutton")){
var _3a7=_3a6.find("input:first").attr("name");
if(!_.has(rabbit.plugins.valueChanged.listenedGroups,_3a7)){
rabbit.plugins.valueChanged.listenedGroups[_3a7]=[];
$("input[name=\""+_3a7+"\"]").change(function(e){
var _3a8=$(e.target).val();
var _3a9=$(e.target).data("old-selected-radiobutton-id");
for(var i=0;i<rabbit.plugins.valueChanged.listenedGroups[_3a7].length;i++){
var _3aa=rabbit.plugins.valueChanged.listenedGroups[_3a7][i];
var _3ab=_3aa.data.stencilId;
var _3ac=_3aa.data.action.selected;
if(_3a8===_3ab&&_3ac==="yes"||_3a9===_3ab&&_3ac==="no"||(_3a8===_3ab||_3a9===_3ab)&&_3ac==="toggle"){
rabbit.interaction.manager.raiseInteraction(_3aa,rabbit.interaction.manager.serializeEvent(e));
}
}
$("input[name=\""+_3a7+"\"]").data("old-selected-radiobutton-id",_3a8);
});
}
rabbit.plugins.valueChanged.listenedGroups[_3a7].push(_3a4);
}else{
if(_3a6.hasClass("checkbox")){
$("#"+_3a4.data.stencilId+" input:first").change(function(e){
if($(e.target).is(":checked")===(_3a4.data.action.selected==="yes")||_3a4.data.action.selected==="toggle"){
rabbit.interaction.manager.raiseInteraction(_3a4,rabbit.interaction.manager.serializeEvent(e));
}
});
}else{
if(_3a6.hasClass("iphoneSwitch")){
var _3ad=function(id){
if(_3a4.data.stencilId===id){
rabbit.interaction.manager.raiseInteraction(_3a4);
}
};
if(_3a4.data.action.selected==="yes"||_3a4.data.action.selected==="toggle"){
rabbit.facade.registerOnEvent(rabbit.events.switchOffSwitch,_3ad,this);
}
if(_3a4.data.action.selected==="no"||_3a4.data.action.selected==="toggle"){
rabbit.facade.registerOnEvent(rabbit.events.switchOnSwitch,_3ad,this);
}
}
}
}
}});
rabbit.facade.registerAction("stringValueChanged",{makeableOnDesktop:true,render:function(_3ae){
return t("interaction.action.stringValueChanged.userDescription");
},defineEvent:function(_3af){
$("#"+_3af.data.stencilId).change(function(e){
if(e.target.value===_3af.data.action.value){
rabbit.interaction.manager.raiseInteraction(_3af,rabbit.interaction.manager.serializeEvent(e));
}
});
}});
}};
...
rabbit.facade.registerOnEvent(rabbit.events.newInteractionRegistered,function(_3b0){
var _3b1=document.getElementById(_3b0.getData().stencilId);
var _3b2=_3b1.hasAttribute("data-stencil-id");
var _3b3=_3b1.hasAttribute("data-layer-id");
var id=_3b0.getData().stencilId;
if(!_3b2&&!_3b3&&!this.detailFootnotes[id]){
this.detailFootnotes[id]=_.size(this.detailFootnotes)+1;
}
},this);
rabbit.facade.registerOnEvent(rabbit.events.pageReady,function(){
$(".has-footnote").each(function(_3b4,_3b5){
var _3b6=_3b5.getAttribute("data-stencil-id");
if(!_3b6){
_3b6=_3b5.getAttribute("data-layer-id");
}
if(!this.detailFootnotes[_3b6]){
this.detailFootnotes[_3b6]=_.size(this.detailFootnotes)+1;
}
}.bind(this));
},this);
...
},showFootnote:function(_3b7,x,y,type,_3b8,_3b9,_3ba,_3bb,text,_3bc){
var _3bd=_3b7.offset();
var _3be=x;
var _3bf=y;
if(!_3ba){
_3be-=_3bd.left;
...
if(!_3b9){
if(type=="detail"){
_3c0=(this.counterDetailFootnotes++)+1;
}else{
if(type=="discussion"){
_3c0=this.getDiscussionLetters(this.counterDiscussionFootnotes++);
}
}
_3c1=$("<div class=\"footnote-marker footnote-marker-"+type+"\">"+_3c0+"</div>").css({left:_3be,top:_3bf});
_3b7.append(_3c1);
}
this.placedMarkers.push({stencilOrLayerId:_3b8,stencilUniqueId:_3b7.attr("id"),type:type,index:_3c0,x:x,y:y,outsideOfPage:_3b9,inStencilInteraction:_3ba,target:_3bb,text:text,footnoteId:_3bc,footnoteElement:_3c1});
},getShownFootnoteIndexes:function(type){
var _3c2={};
for(var i=0;i<this.placedMarkers.length;i++){
var _3c3=this.placedMarkers[i];
if(!type||_3c3.type==type){
_3c2[_3c3.index]={index:_3c3.index,stencilUniqueId:_3c3.stencilUniqueId,outsideOfPage:_3c3.outsideOfPage,inStencilInteraction:_3c3.inStencilInteraction,stencilOrLayerId:_3c3.stencilOrLayerId,target:_3c3.target,text:_3c3.text,footnoteId:_3c3.footnoteId};
}
}
return _3c2;
...
},showDetailFootnotes:function(_3c4){
for(var _3c5 in this.detailFootnotes){
var _3c6=false;
var _3c7=$("[data-stencil-id=\""+_3c5+"\"], .wrapper[data-layer-id=\""+_3c5+"\"][data-layer-id=\""+_3c4+"\"]");
var _3c8=null,text=null;
if(!_3c7.length){
_3c7=$("#"+_3c5);
_3c6=true;
_3c8=_3c7.attr("data-href");
text=_.str.clean(_3c7.text());
text=_.str.truncate(text,20);
_3c5=null;
}
for(var i=0;i<_3c7.length;i++){
var _3c9=$(_3c7.get(i));
if(!_3c9.closest(".wrapper[data-layer-id=\""+_3c4+"\"]").length){
continue;
}
var _3ca=_3c9.offset();
var _3cb=_3c9.width();
if(_3c6){
_3cb=_3c9.width()/2;
}
var x=_3ca.left+_3cb;
var y=_3ca.top-20;
var _3cc=this.findPosition(x,y,"x",1);
this.placedMarkersInPageCoordinateSystem.push({x:_3cc.x,y:_3cc.y});
if(_3c6){
var _3cd=_3c9.position();
_3cc.x=_3cd.left+_3cb+(x-_3cc.x);
_3cc.y=_3cd.top-20+(y-_3cc.y);
}
this.showFootnote(_3c9,_3cc.x,_3cc.y,"detail",_3c5,_3cc.outsideOfPage,_3c6,_3c8,text);
}
}
this.sortFootenotes();
},sortFootenotes:function(){
this.placedMarkers=_.sortBy(this.placedMarkers,function(_3ce){
return ($(_3ce.footnoteElement).offset())?$(_3ce.footnoteElement).offset().left:100000;
});
for(var i=0;i<this.placedMarkers.length;i++){
var _3cf=this.placedMarkers[i].footnoteElement;
$(_3cf).text(i+1);
this.placedMarkers[i].index=i+1;
}
},getShownDetailFootnotes:function(){
return this.getShownFootnoteIndexes("detail");
},getDiscussionLetters:function(_3d0){
var v="abcdefghijklmnopqrstuvwxyz".split("");
var _3d1="";
var nr=Math.floor(_3d0/26);
var mod=_3d0%26;
...
_3d1+=v[mod];
return _3d1;
},showDiscussionFootnotes:function(_3d2){
var _3d3="abcdefghijklmopqrestuvwxyz".split("");
var _3d4=$("#repository").offset();
var _3d5=this.discussionFootnotes[_3d2];
if(_.isArray(_3d5)){
for(var i=0;i<_3d5.length;i++){
var _3d6=_3d5[i];
var _3d7=_3d6.referenceId;
var _3d8=$(".wrapper-"+_3d2+">.layer [data-stencil-id=\""+_3d7+"\"]");
if(_3d8.length===0){
_3d8=$("[data-page-id=\"page0001\"]");
}
for(var j=0;j<_3d8.length;j++){
var _3d9=$(_3d8.get(j));
var _3da=_3d9.offset();
var x=_3da.left+_3d6.x;
var y=_3da.top+_3d6.y;
var _3db=this.findPosition(x,y,"x",1);
this.placedMarkersInPageCoordinateSystem.push({x:_3db.x,y:_3db.y});
this.showFootnote(_3d9,_3db.x,_3db.y,"discussion",_3d6.id,_3db.outsideOfPage,null,null,null,_3d6.id);
}
}
}
},getShownDiscussionFootnotes:function(){
return this.getShownFootnoteIndexes("discussion");
},findPosition:function(x,y,_3dc,deep){
deep=deep||1;
...
return this._findPosition(x,y,_3dc,deep);
}
},_findPosition:function(x,y,_3dd,deep){
var _3de={x:x,y:y,outsideOfPage:false};
var _3df=false;
var _3e0=null;
var _3e1=null;
var _3e2=null;
...
var _3e4=true;
var _3e5=true;
var _3e6=this.placedMarkersInPageCoordinateSystem[i];
var _3e7=x-_3e6.x;
if(Math.abs(_3e7)<this.markerSize){
_3e4=false;
if(_3e7>0){
_3e0=Math.abs(_3e7);
}else{
...
var _3e8=y-_3e6.y;
if(Math.abs(_3e8)<this.markerSize){
_3e5=false;
if(_3e8>0){
_3e2=Math.abs(_3e8);
}else{
...
_3de.x=Math.min(_3de.x,$("#repository").width()-2*this.markerSize);
_3de.y=Math.min(_3de.y,$("#repository").height()-2*this.markerSize);
if(_3df&&deep<100){
if(_3dd=="x"){
var _3e9=true;
if(_3e1===null&&x<xMax||_3e0!==null&&_3e1<_3e0||x<0){
_3e9=false;
}
if(_3e9){
_3de.x=x-this.markerSize;
}else{
_3de.x=x+this.markerSize;
}
}
if(_3dd=="y"){
var _3ea=true;
if(_3e3===null&&y<yMax||_3e2!==null&&_3e3<_3e2||y<0){
_3ea=false;
}
if(_3ea){
_3de.y=y-this.markerSize;
}else{
_3de.y=y+this.markerSize;
}
}
return this.findPosition(_3de.x,_3de.y,(_3dd==="x")?"y":"x",++deep);
}else{
return _3de;
}
}};
...
},highlightStencil:function(_3eb){
var _3ec=$("<div class=\"stencil-highlighter-highlighted\"></div>");
_3eb.append(_3ec);
},hideHighlightLayer:function(_3ed){
$(".layer[data-layer-id=\""+_3ed+"\"] .stencil .stencil-highlighter-highlighted").remove();
},showHighlightLayer:function(_3ee){
this.hideHighlightLayer(_3ee);
var _3ef=$(".layer[data-layer-id=\""+_3ee+"\"] .stencil");
for(var i=0;i<_3ef.length;i++){
this.highlightStencil($(_3ef.get(i)));
}
},deopacify:function(){
$(".stencil-highlighter-opacifyied").removeClass("stencil-highlighter-opacifyied");
},opacifyExceptLayer:function(_3f0){
this.deopacify();
var _3f1=$(".stencil");
for(var i=0;i<_3f1.length;i++){
var _3f2=$(_3f1.get(i));
if(!_3f2.closest(".layer[data-layer-id=\""+_3f0+"\"]").length){
_3f2.addClass("stencil-highlighter-opacifyied");
}
}
}};
...
var _3f3=document.querySelectorAll(".layer");
for(var i=0;i<_3f3.length;i++){
this.activateLinksForLayer(_3f3[i]);
}
},this);
rabbit.facade.registerOnEvent("layerStoreInserted",this.activateLinksForLayer,this);
},activateLinksForLayer:function(_3f4){
var _3f5=_3f4.querySelectorAll(".default-text2-container a[href]");
...
var id=link.id;
var _3f6=link.getAttribute("href");
rabbit.interaction.manager.registerInteraction(id,"tinymce-interaction-"+id,{"button":"left","id":"tinymce-action-"+id,"numberOfFinger":"1","type":"click"},[{"delay":"0","id":"tinymce-reaction-"+id,"options":"reloadOnly","target":_3f6,"transition":"none","type":"showPage"}]);
link.className=link.className+" pidoco-clickable-element interactive-element-highlighter";
link.setAttribute("data-href",_3f6);
...
$.ajax({url:rabbit.common.baseUrl+rabbit.util.appendVersionQuery("common/stencil-icons.svg"),method:"GET",success:function(data,_3f7,_3f8){
...
$.ajax({url:rabbit.common.baseUrl+rabbit.util.appendVersionQuery("common/frames.svg"),method:"GET",success:function(data,_3f9,_3fa){
var body=document.body;
body.insertBefore(data.firstChild,body.firstChild);
...
_3fb=rabbit.parameters.fitScreen;
}
}
var _3fc=false;
if(rabbit.parameters.isApi){
...
_3fc=!rabbit.parameters.showFrame;
}
}
rabbit.facade.registerUserPref("simulationFitScreen",_3fb);
rabbit.facade.registerUserPref("hidePageFrameSimulation",_3fc);
...
this.updateFrame(this.lastPage,this.lastRepository);
},frameReset:function(page,_3ff){
this.simulationScaled.css({transform:"scale(1)"});
this.borderWrapper[0].style.removeProperty("width");
this.borderWrapper[0].style.removeProperty("height");
},pageReady:function(page,_400){
this.lastPage=page;
this.lastRepository=_400;
this.pageLoaded(page,_400);
if(rabbit.facade.getUserPref("hidePageFrameSimulation")){
this.hideFrame();
}
setTimeout(function(){
...
},pageLoaded:function(page,_401,_402){
if(_401.attr("id")!="repository"){
return;
}
this.lastPage=page;
this.lastRepository=_401;
var _403=page.getData().frame;
var _404=page.getData().frameOrientation;
var _405=!rabbit.facade.getUserPref("hidePageFrameSimulation");
if(!rabbit.common.frames[_403]||!rabbit.common.frames[_403][_404]){
this.hideFrame(true);
}else{
if(_405){
this.showFrame(true);
...
},updateFrame:function(page,_406,_407){
if(!this.framesLoaded){
return;
}
var _408=true;
if(!_407){
this.frameReset(page,_406);
_408=false;
}
var _409=page.getData().frame;
var _40a=page.getData().frameOrientation;
var _40b=rabbit.common.frames.none;
var _40c=page.getData().width;
var _40d=page.getData().height;
var _40e=0;
var _40f=0;
if(_409=="custom"){
_40a="custom";
...
if((!rabbit.common.frames[_409]||!rabbit.common.frames[_409][_40a])){
...
var _410=_409=="custom"&&(_40c<rabbit.common.frames.custom.sideMinLength||_40d<rabbit.common.frames.custom.sideMinLength);
if(!this.pageTooSmallForCustom&&_410){
...
var _411=!rabbit.facade.getUserPref("hidePageFrameSimulation");
if(_411){
_40b=rabbit.common.frames[_409];
if(_409!=="custom"){
_40c=_40b[_40a].innerWidth;
_40d=_40b[_40a].innerHeight;
}
_40e=_40b[_40a].frameBorderLeft;
_40f=_40b[_40a].frameBorderTop;
rabbit.facade.isFrameDisplayed=true;
}else{
rabbit.facade.isFrameDisplayed=false;
}
this.frame.firstElementChild.setAttribute("xlink:href","#"+_409+"-"+_40a);
this.simulationScaled.css({transform:"scale(1)"});
var _412=1;
if(rabbit.facade.getUserPref("simulationFitScreen")&&!_408&&_411){
var _413=30;
var _414=_40b[_40a].frameBorderTop*2+_40d+10;
_412=Math.min(1,(window.innerHeight-$(".toolbar-wrapper").height()-_413)/_414);
}
rabbit.facade.setScaleFactor(_412);
var _415=(rabbit.facade.isApi()||$("body").hasClass("plain"))?0:10;
this.simulationContainer.css({width:(_40e*2+_40c+_415)*_412,height:(_40f*2+_40d+_415)*_412});
var _416=_40c;
var _417=_40d;
this.borderWrapper.css("overflow","hidden");
if(!rabbit.facade.getUserPref("hidePageFrameSimulation")&&this.borderWrapper[0].scrollWidth>_416){
_417+=rabbit.util.getScrollbarWidth();
}
if(!rabbit.facade.getUserPref("hidePageFrameSimulation")&&this.borderWrapper[0].scrollHeight>_417){
_416+=rabbit.util.getScrollbarWidth();
}
this.borderWrapper.css({left:_40e,top:_40f,width:_416,height:_417,overflow:"auto"});
this.simulationScaled.css({transform:"scale("+_412+")"});
$("[data-apply-scale-factor]").css({transform:"scale("+_412+")"});
if(_409=="custom"){
rabbit.common.frames.adjusteCustomFrame(_40c,_40d);
}
rabbit.facade.raiseEvent(rabbit.events.frameChanged,_409,_40a);
}};
...
var _418=rabbit.facade.getUserPref("simulationAlignment");
if(_418&&rabbit.plugins.prototypeAlignment[_418]&&!rabbit.facade.isPhantomJS()){
rabbit.plugins.prototypeAlignment[_418]();
}
},left:function(){
...
Mousetrap.bind("ctrl",function(_419){
if(!this.keyPressed){
...
var _41a=rabbit.facade;
return {init:function(){
_41a.registerAction("onPageLoad",{makeableOnDesktop:true,render:function(_41b){
return t("interaction.action.onPageLoad.userDescription");
},defineEvent:function(_41c){
var _41d=$("#"+_41c.data.stencilId).data("layerId");
rabbit.facade.registerOnEvent(rabbit.events.pageLoaded,function(page,_41e){
if(_41d===page.data.id){
rabbit.interaction.manager.raiseInteraction(_41c,{});
}
},this);
rabbit.facade.registerOnEvent(rabbit.events.pageReady,function(page,_41f){
if(_41d===page.data.id){
rabbit.interaction.manager.raiseInteraction(_41c,{});
}
},this);
...
return {init:function init(){
},setupAutocomplete:function setupAutocomplete(id,_420){
_420=_420.split("|c");
var oDS=new YAHOO.util.LocalDataSource(_420);
...
},layerStoreInsertedListener:function(_421){
$(_421).find(".stencil.textinput").click(function(){
rabbit.facade.markHighlightTouchesAsSuccessful();
});
...
rabbit.facade.registerOnEvent(rabbit.events.layerStoreInserted,this.layerStoreInsertedListener,this);
rabbit.facade.registerOnEvent(rabbit.events.pageReady,this.pageReadyListener,this);
},layerStoreInsertedListener:function(_422){
$(_422).find(".stencil.combobox").click(function(){
rabbit.facade.markHighlightTouchesAsSuccessful();
});
},pageReadyListener:function(){
...
var _423=600;
var _424=".accordion-header";
var _425=".accordion-content";
var _426="accordion-active";
var _427=30;
var _428=function(_429){
var _42a=$(_429).parents().children(_424);
var _42b=_42a.index(_429);
return _42b;
};
var _42c=function(_42d){
return $(_42d).closest(".stencil").attr("id");
};
var _42e=function(_42f){
return $("#"+_42f).find(_424).length;
};
var _430=function(_431,_432,_433){
var _434=$("#"+_431+">div>"+_424).length;
$("#"+_431).find(_425+">div, "+_425+">iframe").css("position","relative").css("left","0px").css("top","0px").css("width",_432+"px").css("height",(_433-_434*_427-2)+"px");
};
return {_accordions:{},init:function init(){
},setupAccordion:function(id,_435,_436,_437){
var _438=_42e(id);
if(_437<1){
_437=1;
}
...
_437--;
$("#"+id).find(_424).click({"accordionObject":this},this.raiseClickCallback);
_430(id,_435,_436);
this.showTab(id,_437,false);
},showTab:function(id,_439,_43a){
this._accordions[id]=_439;
if(_43a){
$("#"+id).find(_425).slideUp(_423);
}else{
$("#"+id).find(_425).hide();
}
var _43b=$("#"+id).find(_424).removeClass(_426)[_439];
$(_43b).addClass(_426).next().slideDown(_423,function onCompleteCallback(){
...
},clickCallback:function(that,_43c){
var _43d=_428(_43c);
var _43e=_42c(_43c);
if(that._accordions[_43e]===_43d){
return;
}
rabbit.facade.markHighlightTouchesAsSuccessful();
that.showTab(_43e,_43d,true);
}};
}();
...
var _43f=rabbit.facade;
return {init:function init(){
_43f.registerOnEvent(rabbit.events.buttonMouseOver,this.onMouseOver,this);
_43f.registerOnEvent(rabbit.events.buttonMouseOut,this.onMouseOut,this);
...
var _440=rabbit.facade;
return {init:function init(){
rabbit.facade.registerOnEvent(rabbit.events.checkBoxClicked,this.onClick,this);
},onClick:function onClick(_441,_442){
rabbit.facade.markHighlightTouchesAsSuccessful();
console.log("Click to checkbox "+_441);
var _443=document.getElementById(_441);
if(_443==null){
return true;
}
var _444=document.getElementById(_442);
if(_444==null){
return true;
}
if(!_443.checked){
_444.setAttribute("visibility","hidden");
}else{
_444.setAttribute("visibility","inherit");
}
return true;
}};
}();
...
var _445=rabbit.facade;
var _446=[];
var _447=false;
var _448=null;
var _449=function(id){
for(var i=0;i<_446.length;i++){
var _44a=_446[i];
if(_44a.calendarId==id){
return _44a;
}
}
return null;
};
var _44b=function(id,year,_44c){
var _44d=_449(id);
_44d.calendar.setYear(year);
_44d.calendar.setMonth(_44c);
_44d.calendar.render();
};
var _44e=function _hideCalendar(id,_44f,_450){
if(_44f){
document.getElementById(id+"_input").value=_44f;
}
var _451=_449(id);
_451.calendarVisible=false;
var svg=document.getElementById(_451.calendarId+"_open_calendar");
if(svg){
...
_451.overlay.hide();
_447=false;
$("html").unbind("click",_448);
};
var _452=function _showCalendar(id,_453){
var _454=_449(id);
_454.calendarVisible=true;
_454.calendar.show();
_454.overlay.show();
_447=true;
...
$("html").bind("click",_448);
};
var _455=function _455(_456){
for(var i=0;i<_456.childNodes.length;i++){
var _457=_456.childNodes[i];
if(_457.nodeType!=1){
continue;
}
if(_457.getAttribute("id")==undefined){
_457.setAttribute("id",_456.getAttribute("id")+"_"+i);
}
arguments.callee(_457);
}
};
var _458=function _458(evt){
if(!evt){
return;
}
if(!_445.vml){
...
return {init:function init(){
_445.registerOnEvent(rabbit.events.click,this.hideDatePickerOnClick,this);
rabbit.facade.registerOnEvent(rabbit.events.showDatepicker,_452,this);
rabbit.facade.registerOnEvent(rabbit.events.hideDatepicker,_44e,this);
rabbit.facade.registerOnEvent(rabbit.events.changeDatepickerPage,_44b,this);
},calendarOpen:function(id){
return _447;
}(),setupDatepicker:function setupDatepicker(id){
try{
var _459=new YAHOO.widget.Overlay(id+"_ov",{zIndex:9990,width:"200px",height:"200px",context:[id+"_input","tl","bl"]});
_459.render();
...
_45a.overlay=_459;
_45a["calendarId"]=id;
_45a["calendarVisible"]=false;
_446.push(_45a);
cal.selectEvent.subscribe(rabbit.util.bind(function(evt,d){
var _45b=this.formatIsoDate(d[0][0][0],d[0][0][1],d[0][0][2]);
rabbit.facade.raiseEvent(rabbit.events.hideDatepicker,_45a.calendarId,_45b,rabbit.util.userRole,"displayMouseClick");
},this),cal,true);
cal.render();
cal.hide();
_459.hide();
var _45c=id+"_cal";
_455(document.getElementById(id+"_cal"));
cal.changePageEvent.subscribe(rabbit.util.bind(function(evt,d){
var date=cal.cfg.getProperty("pagedate");
var year=date.getUTCFullYear();
var _45d=date.getMonth();
rabbit.facade.raiseEvent(rabbit.events.changeDatepickerPage,_45a.calendarId,year,_45d,rabbit.util.userRole,"displayMouseClick");
_455(document.getElementById(_45c));
},this),cal,true);
YAHOO.util.Event.addListener(id+"_button","click",rabbit.util.bind(this.toggleCalendarCallback,this),_45a);
YAHOO.util.Event.addListener(id+"_input","focus",rabbit.util.bind(this.toggleCalendarCallback,this),_45a);
YAHOO.util.Event.addListener(id+"_ov","click",_458);
}
catch(e){
...
for(var i=0;i<_446.length;i++){
var _45e=_446[i];
if(_45e.calendarVisible){
rabbit.facade.raiseEvent(rabbit.events.hideDatepicker,_45e.calendarId,null,rabbit.util.userRole,"displayMouseClick");
}
}
}
},toggleCalendarCallback:function toggleCalendarCallback(evt,_45f){
if(!_45f.calendarVisible){
rabbit.facade.raiseEvent(rabbit.events.showDatepicker,_45f.calendarId,rabbit.util.userRole,"displayMouseClick");
this.calendarOpen=true;
}else{
rabbit.facade.raiseEvent(rabbit.events.hideDatepicker,_45f.calendarId,null,rabbit.util.userRole,"displayMouseClick");
...
var _463=function(_464,_465){
var menu=_461(_464);
if(menu){
for(var i=0;i<_465.length;i++){
var _466=menu.getSubmenus();
for(var j=0;j<_466.length;j++){
if(_466[j].id==_465[i]){
menu=_466[j];
}
}
...
var _467=function(_468,_469,_46a){
if(_46a&&_46a!=rabbit.util.userRole){
var _46b=_463(_468,_469);
if(_46b){
_46b.show();
}
}
};
var _46c=function(_46d,_46e,_46f){
if(_46f&&_46f!=rabbit.util.userRole){
var _470=_463(_46d,_46e);
if(_470){
_470.hide();
}
}
};
var _471=function(obj){
var menu=obj;
var _472=[];
...
$(_476.element).css({left:$(_476.parent.element).position().left,top:top});
};
var _477=function(_478){
var _479=-4;
var _47a=$(_478.parent.element);
$(_478.element).css({left:_47a.width()+1/rabbit.facade.getScaleFactor(),top:_47a.position().top/rabbit.facade.getScaleFactor()+_479});
};
var _47b=function(){
var _47c=$(this.element.parentNode).hasClass("yuimenubaritem");
if(_47c){
_475(this);
$(this.element).on("mouseout",function(_47d){
var to=_47d.target?_47d.target:_47d.toElement;
...
var _47e=_471(this);
rabbit.facade.raiseEvent(rabbit.events.subMenuShow,_47e[0],_47e[1],rabbit.util.userRole);
};
var _47f=function(){
var _480=_471(this);
rabbit.facade.raiseEvent(rabbit.events.subMenuHide,_480[0],_480[1],rabbit.util.userRole);
};
return {init:function(){
rabbit.facade.registerOnEvent(rabbit.events.subMenuShow,_467,this);
rabbit.facade.registerOnEvent(rabbit.events.subMenuHide,_46c,this);
},convertMethodIntoFunction:function(_481){
for(var i=0;i<_481.length;i++){
var _482=_481[i].onclick;
if(_482&&_482.fn!=="undefined"){
_482.fn=eval(_482.fn);
_481[i].classname="interactive-element-highlighter";
}
if(_481[i].submenu){
var _483=_481[i].submenu.itemdata;
this.convertMethodIntoFunction(_483);
}
}
},setupMenu:function setupMenu(id,_484,_485){
try{
_484=_484.replace(/:rabbit.result.manager.menuClick,/g,":\"rabbit.result.manager.menuClick\",");
_484=JSON.parse(_484);
this.convertMethodIntoFunction(_484);
var _486;
if(_485=="vertical"){
_486=new YAHOO.widget.Menu(id+"-bar",{itemdata:_484,visible:true,position:"static",hidedelay:750,lazyload:true});
}else{
_486=new YAHOO.widget.MenuBar(id+"-bar",{lazyload:true,autosubmenudisplay:true,showdelay:10,itemdata:_484});
}
_486.render(id+"-menu-container");
_486.show();
_486.domId=id;
_460.push(_486);
_486.subscribe("show",_47b);
_486.subscribe("hide",_47f);
}
catch(e){
console.error(e);
}
...
var _487=rabbit.facade;
return {init:function init(){
_487.registerOnEvent(rabbit.events.radioButtonClicked,this.onClick,this);
...
var _488=[];
var _489=document.getElementsByTagName("input");
for(var i=0;i<_489.length;i++){
if(_489[i].type==="radio"){
_488.push(_489[i]);
}
}
return _488;
},onClick:function onClick(_48a,_48b){
rabbit.facade.markHighlightTouchesAsSuccessful();
console.log("Click to radioButton "+_48a);
var _48c=this.getAllRadioButtons();
for(var i=0;i<_48c.length;i++){
var _48d=_48c[i];
var _48e=_48d.getAttribute("id")+"_svgChecked";
var _48f=document.getElementById(_48e);
if(_48f!=null){
if(!_48d.checked){
if(rabbit.facade.vml){
_48f.style.setAttribute("display","none");
}else{
_48f.setAttribute("visibility","hidden");
}
}else{
if(rabbit.facade.vml){
_48f.style.removeAttribute("display");
}else{
_48f.setAttribute("visibility","inherit");
}
}
}
}
...
var _490={};
var _491=function(_492,_493,_494){
var _495=_490[_492];
if(!_495){
return;
}
if(_494!=null&&_494!=rabbit.util.userRole){
console.log("_sliderChangedCallback "+_493);
_495.setValue(_493);
}
};
return {init:function init(){
rabbit.facade.registerOnEvent(rabbit.events.sliderChangedEvent,_491,this);
},setupSlider:function(id,_496,_497,_498,_499){
try{
_496=parseInt(_496);
_498=parseInt(_498);
if(_499){
_499=parseInt(_499)*2;
}else{
_499=0;
}
var _49a=(_498-(_498)/21)/10;
var _49b=_49a*_496;
var _49c=_498-_49b;
var _49d=null;
if(_497=="vertical"){
_49d=YAHOO.widget.Slider.getVertSlider(id,id+"_thumb_vert",_49c,_49b,_49a);
}else{
_49d=YAHOO.widget.Slider.getHorizSlider(id,id+"_thumb_horiz",_49c,_49b,_49a);
}
_490[id]=_49d;
_49d.animate=false;
_49d.subscribe("change",function(){
var _49e=Math.round(this.getValue()+_499);
rabbit.facade.raiseEvent(rabbit.events.sliderChangedEvent,id,_49e,rabbit.util.userRole);
});
}
catch(e){
console.error(e);
...
var _49f=rabbit.facade;
var _4a0=function _4a0(_4a1,_4a2){
var node=document.getElementById(_4a1);
if(node){
node.style.setProperty("fill",_4a2,"");
}
};
var _4a3=function _4a3(_4a4,_4a5){
var _4a6,node=document.getElementById(_4a4);
if(node){
if(_4a5=="url(#sketchedHover)"){
_4a6=node.ownerDocument.createElement("v:fill");
_4a6.setAttribute("src",rabbit.common.baseUrl+"result/icons/sketchedFilledButton.png");
_4a6.setAttribute("type","tile");
_4a6.setAttribute("origin","0.1,0.1");
_4a6.setAttribute("size","175pt,75pt");
_4a6.setAttribute("on","true");
node.getElementsByTagName("fill")[0].parentNode.replaceChild(_4a6,node.getElementsByTagName("fill")[0]);
}else{
_4a6=node.ownerDocument.createElement("v:fill");
_4a6.setAttribute("color",_4a5);
_4a6.setAttribute("on"," true");
node.getElementsByTagName("fill")[0].parentNode.replaceChild(_4a6,node.getElementsByTagName("fill")[0]);
}
}
...
return {init:function init(){
_49f.registerOnEvent(rabbit.events.svgFocus,this.onSvgFocus,this);
_49f.registerOnEvent(rabbit.events.svgBlur,this.onSvgBlur,this);
_49f.registerOnEvent(rabbit.events.propertyChange,this.onPropertyChanged,this);
},setFill:function setFill(id,_4a7){
if(rabbit.facade.vml){
_4a3(id,_4a7);
}else{
_4a0(id,_4a7);
}
},onSvgFocus:function onSvgFocus(_4a8){
var _4a9;
if(_4a8 instanceof Array){
for(var key in _4a8){
_4a9=document.getElementById(_4a8[key]);
if(_4a9!=null){
_4a9.setAttribute("class","svg_selected_element");
}
}
}else{
...
},onSvgBlur:function onSvgBlur(_4aa){
var _4ab;
if(_4aa instanceof Array){
for(var key in _4aa){
_4ab=document.getElementById(_4aa[key]);
if(_4ab!=null){
_4ab.setAttribute("class","svg_unselected_element");
}
}
}else{
_4ab=document.getElementById(_4aa);
if(_4ab!=null){
_4ab.setAttribute("class","svg_unselected_element");
}
}
},onPropertyChanged:function onPropertyChanged(_4ac,_4ad){
var _4ae=document.getElementById(_4ad);
if(_4ae==null){
return true;
}
console.debug("Property changed on "+_4ac);
if(event.srcElement[event.propertyName]==false){
_4ae.style.setAttribute("display","none");
}else{
_4ae.style.removeAttribute("display");
}
return true;
}};
}();
...
var _4af=rabbit.facade;
var _4b0=function _4b0(_4b1,_4b2){
var node=document.getElementById(_4b1);
if(node){
node.style.setProperty("fill",_4b2,"");
}
};
var _4b3=function _4b3(_4b4,_4b5){
var _4b6,node=document.getElementById(_4b4);
if(node){
if(_4b5=="url(#sketchedHover)"){
_4b6=node.ownerDocument.createElement("v:fill");
_4b6.setAttribute("src",rabbit.common.baseUrl+"result/icons/sketchedFilledButton.png");
_4b6.setAttribute("type","tile");
_4b6.setAttribute("origin","0.1,0.1");
_4b6.setAttribute("size","175pt,75pt");
_4b6.setAttribute("on","true");
node.getElementsByTagName("fill")[0].parentNode.replaceChild(_4b6,node.getElementsByTagName("fill")[0]);
}else{
_4b6=node.ownerDocument.createElement("v:fill");
_4b6.setAttribute("color",_4b5);
_4b6.setAttribute("on"," true");
node.getElementsByTagName("fill")[0].parentNode.replaceChild(_4b6,node.getElementsByTagName("fill")[0]);
}
}
...
return {init:function init(){
_4af.registerOnEvent(rabbit.events.tabButtonMouseOver,this.handleMouseOver,this);
_4af.registerOnEvent(rabbit.events.tabButtonMouseOut,this.handleMouseOut,this);
_4af.registerOnEvent(rabbit.events.pageLoaded,this.changeTab,this);
_4af.registerOnEvent(rabbit.events.pageReady,this.changeTab,this);
this.oldPageId=null;
},changeTab:function(page,_4b7){
var _4b8="";
if(page){
_4b8=page.data.id;
}
if(this.oldPageId===null){
_4b8=_4af.getCurrentPageId();
}
var _4b9=selectorUtil.getElementsByName("target"+this.oldPageId);
for(var i=0;i<_4b9.length;i++){
rabbit.util.removeClass(_4b9[i],"selected");
}
var _4b9=selectorUtil.getElementsByName("target"+_4b8);
for(var i=0;i<_4b9.length;i++){
rabbit.util.addClass(_4b9[i],"selected");
}
this.oldPageId=_4af.getCurrentPageId();
...
_4b0(id+"_big_path","#EEEEEE");
_4b0(id+"_small_path","#EEEEEE");
}
}
}
catch(e){
...
_4b0(id+"_big_path","white");
_4b0(id+"_small_path","white");
}
}
}
catch(e){
...
var _4ba=0;
var _4bb=".togglesection-header";
var _4bc=".togglesection-content";
var _4bd="content";
var _4be="#borderDiv";
var _4bf="open";
var _4c0=rabbit.facade;
var _4c1=function(_4c2,_4c3){
$("#"+_4c2+_4bd).find(".iframe").css("width",_4c3+"px");
};
return {togglers:{},init:function init(){
rabbit.facade.registerOnEvent(rabbit.events.pageLoaded,this.pageLoaded,this);
rabbit.facade.registerOnEvent(rabbit.events.toggleToggleSection,this.toggle,this);
},setupToggler:function(id,_4c4,_4c5){
this.togglers[id]={id:id,page:_4c4};
$("#"+id).find(_4bb).click(function(){
rabbit.facade.markHighlightTouchesAsSuccessful();
rabbit.facade.raiseEvent(rabbit.events.toggleToggleSection,id);
});
$(_4be).append($("#"+id).find(_4bc));
},pageLoaded:function(_4c6){
for(var _4c7 in this.togglers){
$("#"+this.togglers[_4c7].id+_4bd).hide();
}
},toggle:function(_4c8){
var _4c9=$("#"+_4c8+">div").data("iframe-url");
$("#"+_4c8+_4bd).slideToggle(_4ba,function(){
$("#"+_4c8).toggleClass(_4bf);
});
}};
}();
...
var _4ca=rabbit.facade;
return {init:function init(){
_4ca.registerOnEvent(rabbit.events.iphoneSwitchClicked,this.onClick,this);
},onClick:function onClick(id){
rabbit.facade.markHighlightTouchesAsSuccessful();
var _4cb=$("#"+id+" .stencil-wrapper > div");
var _4cc=rabbit.events.switchOffSwitch;
_4cb.toggleClass("switch-selected");
if(_4cb.hasClass("switch-selected")){
_4cc=rabbit.events.switchOnSwitch;
}
_4ca.raiseEvent(_4cc,id);
}};
}();
...
var _4cd="rating_white.png";
var _4ce="rating_black.png";
var _4cf=rabbit.facade;
var _4d0=new Array();
var _4d1=function(id){
if(_4d0[id]){
return parseInt(_4d0[id]);
}
return 0;
};
...
var _4d4=function(id,_4d5){
var i=1;
_4d5=parseInt(_4d5);
while(true){
var _4d6=document.getElementById(id+"-"+i);
if(_4d6==null){
break;
}
var _4d7=_4d6.getAttribute("src");
_4d7=_4d7.substring(0,_4d7.lastIndexOf("/")+1);
if(i>=_4d5+1){
_4d7+=_4cd;
}else{
_4d7+=_4ce;
}
_4d6.setAttribute("src",_4d7);
i++;
}
};
return {init:function init(){
_4cf.registerOnEvent(rabbit.events.ratingResultChangedEvent,this.onClick,this);
_4cf.registerOnEvent(rabbit.events.ratingMouseOut,this.onMouseOut,this);
_4cf.registerOnEvent(rabbit.events.ratingMouseOver,this.onMouseOver,this);
},onLoad:function onLoad(id,_4d8){
_4d2(id,_4d8);
},onClick:function onClick(id,_4d9){
rabbit.facade.markHighlightTouchesAsSuccessful();
_4d2(id,_4d9);
_4d4(id,_4d9);
},onMouseOut:function onMouseOut(id){
_4d4(id,_4d1(id));
},onMouseOver:function onMouseOver(id,_4da){
_4d4(id,parseInt(_4da));
},checkMouseOutDiv:function(id,_4db){
if(_4db.relatedTarget){
return _4db.relatedTarget.id.indexOf(id)==-1;
}else{
return _4db.toElement.id.indexOf(id)==-1;
}
}};
}();
...
},setupTree:function setupMenu(id,_4dd){
try{
_4dd=_4dd.replace(/&quot;/g,"\"");
_4dd=JSON.parse(_4dd);
this._trees[id]=_4dd;
}
catch(e){
console.error(e);
}
},clickCallback:function(_4de,sth){
var _4df=document.getElementById(_4de+"-buttonvline");
var _4e0="open";
if(_4df){
if(_4df.style.display=="none"){
_4e0="closed";
}
if(_4e0=="closed"){
_4df.style.display="";
...
var elem=document.getElementById(_4de+"-treeviewnodeid");
...
this.update(_4de,_4e0);
}
}
},scrollCallback:function(id,_4e1,_4e2){
var _4e3=document.getElementById(id);
_4e3.scrollTop=_4e1;
_4e3.scrollLeft=_4e2;
},update:function(_4e4,_4e5){
this.setStatus(_4e4,_4e5);
this.recalculateLineLengths(_4e4);
},setStatus:function(_4e6,_4e7){
var tree=this.getTree(_4e6);
if(tree){
this.setStatusOnSubtree(this.getTreeName(_4e6),tree,_4e6,_4e7);
}
},setStatusOnSubtree:function(_4e8,tree,_4e9,_4ea){
if(tree){
for(var i=0;i<tree.length;i++){
var node=tree[i];
var _4eb=_4e8+"-"+i;
if(_4eb==_4e9){
node.treeItemType=(_4ea=="closed"?"-":"+");
return true;
}
if(node.subtree){
if(this.setStatusOnSubtree(_4eb,node.subtree,_4e9,_4ea)){
return true;
}
}
}
}
},recalculateLineLengths:function(_4ec){
var tree=this.getTree(_4ec);
if(tree){
var _4ed=this.getTreeName(_4ec);
var _4ee=document.getElementById(_4ed+"-openingvline");
this.traverseTree(_4ed,_4ee,tree,null);
}
},traverseTree:function(_4ef,node,_4f0,_4f1){
var _4f2=false;
if(_4f1===null){
_4f1={0:0,1:0};
_4f2=true;
...
this.traverseTree(_4ef+"-"+i,_4f6,_4f7,_4f1);
_4f4=_4f3+1;
_4f3=_4f3+_4f1[0];
_4f5=_4f5+_4f1[1];
}
...
_4f8=document.getElementById(_4ef+"-openingvline");
}
if(_4f8){
var _4f9=_4f8.parentNode;
_4f9.style.height=""+(_4dc*_4f3)+"px";
var _4fa=(_4f4-_4f5)*_4dc;
_4f8.style.top=""+_4fa+"px";
}else{
}
if(_4f2||"+"==node.treeItemType){
_4f1[0]=rows+_4f3;
}else{
_4f1[0]=rows;
}
_4f1[1]=rows+_4f5;
},getTree:function(_4fb){
if(_4fb){
var _4fc=this.getTreeName(_4fb);
if(this._trees[_4fc]){
return this._trees[_4fc];
}else{
return null;
}
}
},getTreeName:function(_4fd){
return _4fd.substring(0,_4fd.indexOf("-"));
}};
}();
...
rabbit.common.i18n={translation:{},lang:rabbit.parameters.lang,init:function(_4ff){
this.lang=_4ff.lang;
...
var _502=rabbit.common.i18n.translation[lang][_501];
if(_502!==undefined){
return _502;
}
return key;
},tReverse:function(_503){
for(var lang in rabbit.common.i18n.translation){
for(var _504 in rabbit.common.i18n.translation[lang]){
...
return null;
},tr:function(key,_506){
var _507=this.t(key);
for(var k in _506){
_507=_507.replace(k,_506[k]);
}
return _507;
},translation:{}};
...
},registerUserPref:function(key,_512){
this.userDefaults[key]=_512;
},setUserPref:function(key,_513){
var _514;
try{
_514=JSON.parse(localStorage.getItem(this.userPrefPrefix+key)).value;
}
catch(e){
_514=this.alternativeStorage[key];
}
if(_514!=_513){
rabbit.parameters.userPrefs[key]=_513;
if(this.isLocalStorageSupported){
localStorage.setItem(this.userPrefPrefix+key,JSON.stringify({value:_513}));
}else{
this.alternativeStorage[key]=_513;
}
if(!rabbit.parameters.isAnonymous){
...
var _515;
try{
_515=JSON.parse(localStorage.getItem(this.userPrefPrefix+key)).value;
}
catch(e){
_515=this.alternativeStorage[key];
}
if(_515===undefined||_515===null){
this.setUserPref(key,this.userDefaults[key]);
_515=this.userDefaults[key];
}
return _515;
},mergeUserPref:function(_516){
_.extend(rabbit.parameters.userPrefs,_516);
...
},registerPrototypePref:function(key,_517){
this.prototypeDefaults[key]=_517;
},setPrototypePref:function(key,_518){
if(rabbit.parameters.prototypePrefs[key]!=_518){
rabbit.parameters.prototypePrefs[key]=_518;
this.updatePrototypePref(JSON.stringify(rabbit.parameters.prototypePrefs));
}
},getPrototypePref:function(key){
var _519=rabbit.parameters.prototypePrefs[key];
if((_519===undefined)||(_519===null)){
